...
**Name** | Pointer to **NullableString** | 인스턴스 유형의 이름 | [optional] 
**Vcpus** | Pointer to **NullableInt32** | 가상 CPU 개수 | [optional] 
**Description** | Pointer to **NullableString** | 인스턴스 유형에 대한 설명 | [optional] 
...
**Architecture** | Pointer to **NullableString** | 인스턴스 유형의 CPU 아키텍처 | [optional] 
**Manufacturer** | Pointer to **NullableString** | 인스턴스 유형 제조사 | [optional] 
**Group** | Pointer to **NullableString** | 인스턴스 유형의 분류를 위한 내부 식별자 - &#x60;cpu_optimized&#x60;, &#x60;memory_optimized&#x60; 등 | [optional] 
**InstanceType** | Pointer to **NullableString** | 인스턴스 유형 종류 | [optional] 
**Processor** | Pointer to **NullableString** | 프로세서 이름 | [optional] 
**MemoryMb** | Pointer to **NullableInt64** | 메모리 크기 (MB 단위) | [optional] 
...
**AvailabilityZone** | Pointer to [**[]AvailabilityZone**](AvailabilityZone.md) | 가용 영역 | [optional] 
**Available** | Pointer to **map[string]int32** | 가용 수량 | [optional] 
**InstanceFamily** | Pointer to **NullableString** | 인스턴스 패밀리 명칭 | [optional] 
**InstanceSize** | Pointer to **NullableString** | 인스턴스 크기 | [optional] 
**DiskType** | Pointer to **NullableString** | 디스크 유형 | [optional] 
**RootGb** | Pointer to **NullableInt32** | 루트 디스크 크기 (단위: GB, 기본값: 0) | [optional] 
...
**HwName** | Pointer to **NullableString** | 하드웨어 이름 - 예시: a100 | [optional] 
**MaximumNetworkInterfaces** | Pointer to **NullableInt32** | 최대 네트워크 인터페이스 개수 | [optional] 
**IsHyperThreadingDisabled** | Pointer to **NullableBool** | 하이퍼스레딩 비활성화 여부 | [optional] 
**IsHyperThreadingSupported** | Pointer to **NullableBool** | 하이퍼스레딩 지원 여부 | [optional] 
**IsHyperThreadingDisableSupported** | Pointer to **NullableBool** | 하이퍼스레딩 비활성화 지원 여부 | [optional] 
