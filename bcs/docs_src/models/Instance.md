...
**Flavor** | Pointer to [**NullableInstanceFlavor**](InstanceFlavor.md) | 인스턴스 유형 | [optional] 
**Addresses** | Pointer to [**[]InstanceAddress**](InstanceAddress.md) | 인스턴스에 할당된 네트워크 주소 목록 | [optional] 
**IsHyperThreading** | Pointer to **NullableBool** | 하이퍼스레딩 사용 여부 | [optional] 
**IsHadoop** | Pointer to **NullableBool** | 하둡 클러스터에서 자동 생성된 인스턴스 여부 | [optional] 
**IsK8se** | Pointer to **NullableBool** | Kubernetes Engine 환경용으로 생성된 인스턴스인지 여부 | [optional] 
**Image** | Pointer to [**NullableImage**](Image.md) | 인스턴스에 사용된 이미지 | [optional] 
**Status** | Pointer to **NullableString** | 인스턴스의 상세 상태 | [optional] 
**UserId** | Pointer to **NullableString** | 인스턴스를 생성한 사용자 ID | [optional] 
**ProjectId** | Pointer to **NullableString** | 인스턴스가 속한 프로젝트의 ID | [optional] 
**KeyName** | Pointer to **NullableString** | 인스턴스에 설정된 키페어 이름 | [optional] 
**VmState** | Pointer to **NullableString** | 인스턴스의 상태 코드 | [optional] 
**PowerState** | Pointer to [**NullablePowerState**](PowerState.md) | 인스턴스의 전원 상태 | [optional] 
...
**TaskState** | Pointer to **NullableString** | 작업 상태 | [optional] 
...
**AttachedVolumes** | Pointer to [**[]AttachedVolume**](AttachedVolume.md) | 연결된 볼륨 정보 | [optional] 
**AttachedVolumeCount** | Pointer to **NullableInt64** | 연결된 볼륨 수 | [optional] 
**SecurityGroups** | Pointer to [**[]InstanceSg**](InstanceSg.md) | 인스턴스에 적용된 보안 그룹 목록 | [optional] 
**SecurityGroupCount** | Pointer to **NullableInt64** | 보안 그룹의 개수 | [optional] 
**InstanceType** | Pointer to **NullableString** | 인스턴스의 유형 | [optional] 
