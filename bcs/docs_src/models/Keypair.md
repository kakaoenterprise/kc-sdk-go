...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 키 ID | [optional] 
**Name** | Pointer to **NullableString** | 키 이름 | [optional] 
**UserId** | Pointer to **NullableString** | 사용자 ID | [optional] 
**Fingerprint** | Pointer to **NullableString** | 퍼블릭 키의 고유 핑거프린트 - SSH 클라이언트에서 키 검증 시 사용 | [optional] 
**PublicKey** | Pointer to **NullableString** | 퍼블릭 키 문자열 | [optional] 
