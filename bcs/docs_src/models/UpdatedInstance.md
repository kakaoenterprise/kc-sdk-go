...
**Metadata** | Pointer to **map[string]string** | 인스턴스에 추가적인 사용자 정의 데이터를 저장할 수 있는 필드 | [optional] 
...
**KeyName** | Pointer to **NullableString** | 인스턴스에 적용된 키페어 이름 | [optional] 
**TerminatedAt** | Pointer to **NullableTime** | 종료 시간 | [optional] 
**SecurityGroups** | Pointer to [**[]SecurityGroup**](SecurityGroup.md) | 인스턴스에 적용된 보안 그룹 목록 | [optional] 
**TaskState** | Pointer to **NullableString** | 인스턴스에 현재 수행 중인 작업의 상태 | [optional] 
**VmState** | Pointer to **NullableString** | 인스턴스의 현재 가상머신 상태 | [optional] 
**PowerState** | Pointer to [**NullablePowerState**](PowerState.md) | 전원 상태 코드 | [optional] 
**AttachedVolumes** | Pointer to [**[]UpdatedAttachedVolume**](UpdatedAttachedVolume.md) | 인스턴스에 연결된 블록 스토리지 볼륨 목록 | [optional] 
**Description** | Pointer to **NullableString** | 인스턴스에 대한 설명 | [optional] 
**Hostname** | Pointer to **NullableString** | 인스턴스의 호스트 이름 | [optional] 
**Addresses** | Pointer to [**[]InstanceAddress**](InstanceAddress.md) | 인스턴스에 할당된 IP 주소 | [optional] 
