...
**ContainerFormat** | Pointer to **NullableString** | 이미지 컨테이너 포맷 | [optional] 
**MinDisk** | Pointer to **NullableInt32** | 이미지를 사용할 때 필요한 최소 디스크 크기(GB) | [optional] 
**MinRam** | Pointer to **NullableInt32** | 이미지를 사용할 수 있는 최소 메모리 크기 (MB) | [optional] 
**VirtualSize** | Pointer to **NullableInt64** | 이미지의 가상 크기 | [optional] 
**InstanceType** | Pointer to [**NullableImageInstanceType**](ImageInstanceType.md) | 이미지와 호환 가능한 인스턴스 유형 | [optional] 
**ImageMemberStatus** | Pointer to **NullableString** | 이미지 멤버(프로젝트)의 공유 상태 - 다른 프로젝트로부터 공유받은 이미지인 경우 확인 가능 | [optional] 
**ProjectId** | Pointer to **NullableString** | 프로젝트의 고유 ID | [optional] 
**OsInfo** | Pointer to [**NullableOsInfo**](OsInfo.md) | 이미지의 운영체제 정보 | [optional] 
...
`func (o *Image) SetProjectId(v string)`

SetProjectId sets ProjectId field to given value.

### HasProjectId

`func (o *Image) HasProjectId() bool`

HasProjectId returns a boolean if a field has been set.

### SetProjectIdNil

`func (o *Image) SetProjectIdNil(b bool)`

 SetProjectIdNil sets the value for ProjectId to be an explicit nil

### UnsetProjectId
`func (o *Image) UnsetProjectId()`
