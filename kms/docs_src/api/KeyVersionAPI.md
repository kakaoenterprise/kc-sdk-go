...
> BulkCancelScheduledKeyVersionDestructionResponse BulkCancelScheduledKeyVersionDestruction(ctx, keyId).BulkCancelScheduledKeyVersionDestructionRequest(bulkCancelScheduledKeyVersionDestructionRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.KeyVersionAPI.BulkCancelScheduledKeyVersionDestruction(context.Background(), keyId).BulkCancelScheduledKeyVersionDestructionRequest(bulkCancelScheduledKeyVersionDestructionRequest).Execute()
	if err != nil {
...
> BulkScheduleKeyVersionDestructionResponse BulkScheduleKeyVersionDestruction(ctx, keyId).BulkScheduleKeyVersionDestructionRequest(bulkScheduleKeyVersionDestructionRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.BulkScheduleKeyVersionDestruction(context.Background(), keyId).BulkScheduleKeyVersionDestructionRequest(bulkScheduleKeyVersionDestructionRequest).Execute()
	if err != nil {
...
> CancelScheduledKeyVersionDestructionResponse CancelScheduledKeyVersionDestruction(ctx, keyId, version).Execute()
...
func main() {
	keyId := "keyId_example" // string | KMS 키의 고유 ID - [List user keys](/openapi/security/kms/list-user-keys)에서 확인
	version := "version_example" // string | 대상 키 버전 - [List key versions](/openapi/security/kms/list-key-versions)에서 확인

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.CancelScheduledKeyVersionDestruction(context.Background(), keyId, version).Execute()
	if err != nil {
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**keyId** | **string** | KMS 키의 고유 ID - [List user keys](/openapi/security/kms/list-user-keys)에서 확인 | 
**version** | **string** | 대상 키 버전 - [List key versions](/openapi/security/kms/list-key-versions)에서 확인 | 
...
> CreateKeyVersionResponse CreateKeyVersion(ctx, keyId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.CreateKeyVersion(context.Background(), keyId).Execute()
	if err != nil {
...
> DeactivateKeyVersionResponse DeactivateKeyVersion(ctx, keyId, version).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.DeactivateKeyVersion(context.Background(), keyId, version).Execute()
	if err != nil {
...
> ListKeyVersionsResponse ListKeyVersions(ctx, keyId).Version(version).Status(status).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.ListKeyVersions(context.Background(), keyId).Version(version).Status(status).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
	if err != nil {
...
> ScheduleKeyVersionDestructionResponse ScheduleKeyVersionDestruction(ctx, keyId, version).ScheduleKeyVersionDestructionRequest(scheduleKeyVersionDestructionRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KeyVersionAPI.ScheduleKeyVersionDestruction(context.Background(), keyId, version).ScheduleKeyVersionDestructionRequest(scheduleKeyVersionDestructionRequest).Execute()
	if err != nil {
