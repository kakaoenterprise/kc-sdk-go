...
------------ | ------------- | ------------- | -------------
**CipherText** | **string** | 복호화할 Base64 인코딩 암호문  - [Encrypt data](/openapi/security/kms/encrypt-data) 응답에서 확인 | 
**Aad** | Pointer to **NullableString** | 암호화 또는 복호화에 사용하는 추가 인증 데이터(Additional Authenticated Data) | [optional] 
