...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **NullableString** | 서비스 키 이름 | [optional] 
**DefaultVersion** | Pointer to **NullableInt32** | 서비스 키의 기본 버전 | [optional] 
**Service** | Pointer to **NullableString** | 서비스 키를 사용하는 카카오클라우드 서비스 이름 | [optional] 
**Status** | Pointer to **NullableString** | KMS 키 상태 | [optional] 
