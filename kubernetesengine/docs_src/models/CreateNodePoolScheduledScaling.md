...
**Schedule** | Pointer to **NullableString** | 예약 기반 오토스케일링 실행 주기 - &#x60;schedule_type&#x60;이 &#x60;cron&#x60;일 때만 설정 가능 - 5자리 cron 표현식 입력 - 일간/주간/월간 주기의 표현식만 설정 가능 | [optional] 
**DesiredNodes** | **int32** | 예약 기반 오토스케일링이 수행될 때 원하는 노드 수 설정 | 
**StartTime** | **string** | 예약 기반 오토스케일링이 실제로 실행될 수 있는 기준 시각 - ISO 8601 형식 - UTC 기준 - 지정한 &#x60;start_time&#x60; 이후부터 설정된 주기에 따라 규칙 실행 - 분 단위까지 설정 가능하며, 초 단위는 설정할 수 없음 | 
