...
**IsInverted** | Pointer to **NullableBool** | 규칙의 비교 결과를 반전할지 여부 (기본값: &#x60;false&#x60;) | [optional] 
**Key** | Pointer to **NullableString** | 비교 대상 키 - &#x60;HEADER&#x60;: 헤더 이름 - &#x60;COOKIE&#x60;: 쿠키 이름 - 그 외 유형은 생략 또는 &#x60;null&#x60; | [optional] 
**Type** | [**L7RuleType**](L7RuleType.md) | 규칙을 검사할 대상 유형 - &#x60;COOKIE&#x60;: HTTP 요청의 특정 쿠키 값을 기준으로 검사 - &#x60;FILE_TYPE&#x60;: 요청한 리소스의 파일 확장자(예: &#x60;.jpg&#x60;, &#x60;.exe&#x60;)를 기준으로 검사 - &#x60;HEADER&#x60;: HTTP 요청 헤더 값을 기준으로 검사 - &#x60;HOST_NAME&#x60;: 요청의 Host 헤더(도메인 이름)를 기준으로 검사 - &#x60;PATH&#x60;: 요청 URL 경로(예: &#x60;/images/_*&#x60;, &#x60;/api/v1/_*&#x60;)를 기준으로 검사 | 
