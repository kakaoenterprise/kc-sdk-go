...
------------ | ------------- | ------------- | -------------
**LoadBalancerId** | **string** | 리스너를 생성할 대상 로드 밸런서 ID - [List load balancers](/openapi/networking/lb/list-load-balancers)에서 확인 | 
**Protocol** | [**Protocol**](Protocol.md) | 리스너가 수신할 트래픽의 프로토콜 | 
**ProtocolPort** | **int32** | 수신 포트 번호 | 
**TargetGroupId** | Pointer to **NullableString** | 기본 트래픽 대상이 될 대상 그룹 ID - [List target groups](/openapi/networking/lb/list-target-groups)에서 확인 | [optional] 
