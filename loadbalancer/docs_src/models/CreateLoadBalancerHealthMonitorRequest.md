...
**HttpMethod** | Pointer to [**NullableHealthMonitorMethod**](HealthMonitorMethod.md) | HTTP 요청 방식 | [optional] 
**HttpVersion** | Pointer to [**NullableHealthMonitorHttpVersion**](HealthMonitorHttpVersion.md) | HTTP 프로토콜 버전 | [optional] 
**ExpectedCodes** | Pointer to **NullableString** | 정상 응답 코드 범위 | [optional] 
**UrlPath** | Pointer to **NullableString** | 헬스 체크 요청 경로 | [optional] 
