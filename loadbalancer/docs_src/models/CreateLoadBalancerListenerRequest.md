...
**DefaultTlsContainerRef** | Pointer to **NullableString** | TLS 인증서 Secret 참조 ID - &#x60;secret_ref&#x60; 값은 [List TLS certificates](/openapi/networking/lb/list-tls-certificates)에서 확인 | [optional] 
...
**DefaultTargetGroup** | Pointer to [**NullablePoolRefRequest**](PoolRefRequest.md) | 기본 트래픽 전달 대상 그룹 | [optional] 
**L7Policies** | Pointer to [**[]CreateLoadBalancerL7PolicyRequest**](CreateLoadBalancerL7PolicyRequest.md) | L7 트래픽 처리 정책 목록 | [optional] 
