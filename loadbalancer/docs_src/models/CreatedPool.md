...
**ProvisioningStatus** | Pointer to [**NullableProvisioningStatus**](ProvisioningStatus.md) | 생성/수정 상태 | [optional] 
**OperatingStatus** | Pointer to [**NullableLoadBalancerOperatingStatus**](LoadBalancerOperatingStatus.md) | 실제 동작 상태 | [optional] 
...
**SessionPersistence** | Pointer to [**NullableSessionPersistence**](SessionPersistence.md) | 적용된 세션 유지 설정 | [optional] 
**Members** | [**[]CreatedMember**](CreatedMember.md) | 현재 등록된 서버 목록 | 
**AlpnProtocols** | Pointer to [**[]LoadBalancerAlpnProtocol**](LoadBalancerAlpnProtocol.md) | 적용된 ALPN 프로토콜 | [optional] 
