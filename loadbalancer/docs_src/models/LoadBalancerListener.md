...
**Description** | Pointer to **NullableString** | 리스너에 대한 설명 | [optional] 
**Protocol** | Pointer to [**NullableProtocol**](Protocol.md) | 리스너 프로토콜 | [optional] 
**IsEnabled** | Pointer to **NullableBool** | 리스너 활성화 여부 | [optional] 
**Secrets** | Pointer to [**[]Secret**](Secret.md) | 연결된 인증서 정보 | [optional] 
**L7Policies** | Pointer to [**[]L7Policy**](L7Policy.md) | 연결된 L7 정책 정보 | [optional] 
**TlsCiphers** | Pointer to **NullableString** | TLS 암호화 스위트 목록 (&#x60;TERMINATED_HTTPS&#x60; 프로토콜에만 적용) | [optional] 
**TlsVersions** | Pointer to [**[]TLSVersion**](TLSVersion.md) | 지원하는 TLS 버전 | [optional] 
**ProjectId** | Pointer to **NullableString** | 프로젝트 ID | [optional] 
**ProtocolPort** | Pointer to **NullableInt32** | 연결된 포트 번호 | [optional] 
**LoadBalancerId** | Pointer to **NullableString** | 연결된 로드 밸런서 ID | [optional] 
**TlsCertificateId** | Pointer to **NullableString** | TLS 인증서 ID | [optional] 
...
**InsertHeaders** | Pointer to [**map[string]LoadBalancerListenerInsertHeadersValue**](LoadBalancerListenerInsertHeadersValue.md) | 삽입 헤더 정보 | [optional] 
...
**TimeoutClientData** | Pointer to **NullableInt32** | 클라이언트 데이터 수신 타임아웃 시간 (ms) | [optional] 
**DefaultTargetGroupName** | Pointer to **NullableString** | 기본 대상 그룹 이름 | [optional] 
