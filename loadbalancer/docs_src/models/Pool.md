...
**Protocol** | Pointer to [**NullableLoadBalancerPoolProtocol**](LoadBalancerPoolProtocol.md) | 대상 그룹의 프로토콜 | [optional] 
...
**ProjectId** | Pointer to **NullableString** | 대상 그룹이 속한 프로젝트 ID | [optional] 
**LoadBalancers** | Pointer to [**[]Ids**](Ids.md) | 대상 그룹이 연결된 로드 밸런서 목록 | [optional] 
**Listeners** | Pointer to [**[]UpdatedListener**](UpdatedListener.md) | 대상 그룹이 연결된 리스너 목록 | [optional] 
...
**Members** | Pointer to [**[]MemberResult**](MemberResult.md) | 대상 그룹에 속한 멤버(서버) 목록 | [optional] 
**AlpnProtocols** | Pointer to **[]string** | HTTPS(TERMINATED_HTTPS) 리스너에 연결되는 대상 그룹에서 사용할 ALPN 프로토콜  - &#x60;http/1.1&#x60;, &#x60;h2&#x60; 값만 입력할 수 있으며, HTTPS(TERMINATED_HTTPS) 리스너에 연결된 경우에만 사용 가능 | [optional] 
