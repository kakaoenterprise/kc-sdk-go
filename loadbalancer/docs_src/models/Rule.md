...
------------ | ------------- | ------------- | -------------
**CompareType** | Pointer to [**NullableL7RuleCompareType**](L7RuleCompareType.md) | 규칙 값 비교 방식 | [optional] 
**Id** | Pointer to **NullableString** | L7 규칙의 ID | [optional] 
**IsInverted** | **bool** | 규칙 반전 여부 - &#x60;true&#x60;인 경우 비교 규칙의 반대 결과가 일치로 간주됨 | 
**Key** | Pointer to **NullableString** | 비교 기준 키 | [optional] 
**Value** | Pointer to **NullableString** | 비교할 대상 값 | [optional] 
...
**Type** | Pointer to [**NullableL7RuleType**](L7RuleType.md) | 규칙 유형 | [optional] 
