...
------------ | ------------- | ------------- | -------------
**Type** | [**LoadBalancerSessionPersistenceType**](LoadBalancerSessionPersistenceType.md) | 세션 유형 - 예시: &#x60;APP_COOKIE&#x60;, &#x60;HTTP_COOKIE&#x60;, &#x60;SOURCE_IP&#x60; | 
**CookieName** | Pointer to **NullableString** | 쿠키 이름 (세션 유형이 &#x60;APP_COOKIE&#x60;인 경우) | [optional] 
**PersistenceTimeout** | **int32** | 세션 유지 시간 (초) | 
**PersistenceGranularity** | Pointer to **NullableString** | 세션 유지 기준이 되는 IP 서브넷 마스크 (세션 유형이 &#x60;SOURCE_IP&#x60;인 경우) | [optional] 
