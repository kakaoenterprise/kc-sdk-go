...
**SourceParameterGroupId** | **string** | 기준이 되는 MySQL 파라미터 그룹 ID - &#x60;source_parameter_group_type&#x3D;DEFAULT&#x60;: [List MySQL default parameter groups](/openapi/data-store/mysql/list-mysql-default-parameter-groups)에서 확인 - &#x60;source_parameter_group_type&#x3D;CUSTOM&#x60;: [List MySQL custom parameter groups](/openapi/data-store/mysql/list-mysql-custom-parameter-groups)에서 확인 | 
**SourceParameterGroupType** | [**ParameterGroupType**](ParameterGroupType.md) | 기준이 되는 MySQL 파라미터 그룹 유형 | 
**Description** | Pointer to **NullableString** | 파라미터 그룹 설명 | [optional] 
