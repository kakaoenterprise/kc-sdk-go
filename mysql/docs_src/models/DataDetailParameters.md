...
**DefaultParameterValue** | Pointer to **NullableString** | 기본 파라미터 값 | [optional] 
**IsEditable** | **bool** | 파라미터 수정 가능 여부 | 
**ParameterType** | Pointer to [**NullableParameterType**](ParameterType.md) | 파라미터 유형 | [optional] 
**Value** | Pointer to **NullableString** | 현재 설정된 파라미터 값 | [optional] 
**IsRequired** | **bool** | 필수 파라미터 여부 | 
**ValidationValueFormat** | Pointer to **NullableString** | 파라미터 값 유효성 검증 형식 | [optional] 
