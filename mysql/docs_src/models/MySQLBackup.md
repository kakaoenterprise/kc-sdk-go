...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **NullableString** | 백업 이름 | [optional] 
**CreatedAt** | Pointer to **NullableString** | 백업 생성 시각 (UTC, ISO 8601) | [optional] 
**CreatorName** | Pointer to **NullableString** | 백업을 생성한 사용자 이름 | [optional] 
**Description** | Pointer to **NullableString** | MySQL 백업 설명 | [optional] 
**DiskSize** | Pointer to **NullableInt32** | 백업 생성 시 사용된 디스크 크기 | [optional] 
**ExpireAt** | Pointer to **NullableString** | 백업 만료 시각 (UTC, ISO 8601) | [optional] 
**ExpiryDuration** | Pointer to **NullableInt32** | 백업 보관 기간 (단위: 일) | [optional] 
**ExtraInfo** | Pointer to [**NullableExtraInfo**](ExtraInfo.md) | 백업 생성 시 적용된 추가 설정 정보 | [optional] 
**InstanceGroupId** | Pointer to **NullableString** | 백업이 생성된 MySQL 인스턴스 그룹 ID | [optional] 
**InstanceGroupName** | Pointer to **NullableString** | MySQL 인스턴스 그룹 이름 | [optional] 
**Id** | Pointer to **NullableString** | MySQL 백업의 고유 ID | [optional] 
**ProjectId** | Pointer to **NullableString** | 프로젝트 ID | [optional] 
**Size** | Pointer to **NullableInt64** | 백업 데이터 크기 | [optional] 
**Status** | Pointer to [**NullableBackupStatus**](BackupStatus.md) | MySQL 백업의 현재 상태 | [optional] 
**Type** | Pointer to [**NullableBackupType**](BackupType.md) | 백업 유형 | [optional] 
**StartedAt** | Pointer to **NullableString** | 백업 생성 시작 시각 (UTC, ISO 8601) | [optional] 
**UpdatedAt** | Pointer to **NullableString** | 리소스가 마지막으로 수정된 시간 - ISO 8601 형식 - UTC 기준 | [optional] 
