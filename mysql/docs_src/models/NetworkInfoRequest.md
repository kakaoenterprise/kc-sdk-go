...
------------ | ------------- | ------------- | -------------
**SecurityGroupIds** | **[]string** | 인스턴스 그룹에 적용할 보안 그룹 ID 목록 - [List security groups](/openapi/networking/vpc/list-security-groups)에서 확인 | 
**PrimarySubnetInfo** | [**SubnetInfoRequest**](SubnetInfoRequest.md) | Primary 서브넷 설정 | 
**StandbySubnetInfo** | Pointer to [**[]SubnetInfoRequest**](SubnetInfoRequest.md) | Standby 서브넷 설정 목록 | [optional] 
