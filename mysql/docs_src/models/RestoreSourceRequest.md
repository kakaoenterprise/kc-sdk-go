...
**Id** | **string** | 소스로 사용할 백업 또는 리소스 ID - &#x60;type&#x3D;BACKUP&#x60;: [List MySQL backups](/openapi/data-store/mysql/list-mysql-backups)에서 확인 - &#x60;type&#x3D;INSTANCE_GROUP&#x60;: [List MySQL instance groups](/openapi/data-store/mysql/list-mysql-instance-groups)에서 확인 | 
**Time** | Pointer to **NullableString** | [지정 시점 복원을 위한 기준 시간](/openapi/data-store/mysql/get-mysql-restorable-time) - &#x60;Type&#x60;이 &#x60;INSTANCE_GROUP&#x60;인 경우에만 입력 | [optional] 
