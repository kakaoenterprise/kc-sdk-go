...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 퍼블릭 IP 자원의 ID | [optional] 
**Status** | Pointer to [**NullablePublicIpStatus**](PublicIpStatus.md) | 퍼블릭 IP의 현재 상태 | [optional] 
**Description** | Pointer to **NullableString** | 퍼블릭 IP 자원에 대한 설명 | [optional] 
**ProjectId** | Pointer to **NullableString** | 해당 퍼블릭 IP가 속한 프로젝트의 ID | [optional] 
**PublicIp** | Pointer to **NullableString** | 할당된 퍼블릭 IP 주소 | [optional] 
**PrivateIp** | Pointer to **NullableString** | 해당 퍼블릭 IP가 연결된 프라이빗 IP 주소 (IPv4 형식) | [optional] 
**RelatedResource** | Pointer to [**NullableResource**](Resource.md) | 퍼블릭 IP가 연결된 리소스 정보 | [optional] 
