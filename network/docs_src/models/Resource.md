...
**Status** | Pointer to [**NullableNetworkInterfaceStatus**](NetworkInterfaceStatus.md) | 리소스 상태 | [optional] 
**Type** | Pointer to **NullableString** | 리소스 유형 | [optional] 
**DeviceId** | Pointer to **NullableString** | 디바이스 ID | [optional] 
**DeviceOwner** | Pointer to **NullableString** | 디바이스 소유자 | [optional] 
**SubnetId** | Pointer to **NullableString** | 서브넷 ID | [optional] 
**SubnetName** | Pointer to **NullableString** | 서브넷 이름 | [optional] 
**SubnetCidr** | Pointer to **NullableString** | 서브넷의 IPv4 CIDR 블록 | [optional] 
