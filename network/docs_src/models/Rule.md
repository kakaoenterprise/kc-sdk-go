...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 보안 그룹 규칙의 ID | [optional] 
**Description** | Pointer to **NullableString** | 보안 그룹 규칙에 대한 설명 | [optional] 
**RemoteGroupId** | Pointer to **NullableString** | 다른 보안 그룹의 ID | [optional] 
**RemoteGroupName** | Pointer to **NullableString** | 다른 보안 그룹의 이름 | [optional] 
**Direction** | Pointer to [**NullableRuleDirection**](RuleDirection.md) | 규칙 방향 | [optional] 
**Protocol** | Pointer to [**NullableSecurityGroupRuleProtocol**](SecurityGroupRuleProtocol.md) | 응답에 표시되는 프로토콜 | [optional] 
**PortRangeMin** | Pointer to **NullableString** | 응답에 표시되는 포트 범위 시작 값 | [optional] 
**PortRangeMax** | Pointer to **NullableString** | 응답에 표시되는 포트 범위 끝 값 | [optional] 
