...
type KeypairAPI interface {
	...
	/*
		...
		새로운 키 페어를 생성합니다. 키 페어는 VM 인스턴스에 접속할 때 사용하는 보안 자격 증명입니다.

	키 페어는 퍼블릭 키(Public key)와 프라이빗 키(Private key)로 구성되어 있습니다.

	:::info 안내
	생성한 키 페어 정보는 [Get keypair](/openapi/bcs/get-keypair)에서 확인할 수 있습니다.
	:::

	:::caution 주의
	- 키 페어 생성 시 반환되는 프라이빗 키(`private_key`)는 한 번만 제공되며, 이후 다시 조회할 수 없습니다. 안전한 위치에 저장해 주세요.
	...
	*/
	...
	CreateKeypairExecute(r ApiCreateKeypairRequest) (*CreateKeypairResponse, *http.Response, error)
	...
	- 키 페어 삭제는 기존 인스턴스의 실행 상태에는 영향을 주지 않지만, 삭제된 키 페어로는 인스턴스에 접속할 수 없습니다.
	:::

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param keypairName 삭제할 키 페어의 이름 <br/> - [List keypairs](/openapi/bcs/list-keypairs)에서 확인
	...
	*/
	...
	GetKeypairExecute(r ApiGetKeypairRequest) (*GetKeypairResponse, *http.Response, error)

	/*
		ListKeypairs List keypairs

		사용자가 생성한 키 페어 목록과 각 키 페어의 상세 정보를 조회합니다.
	...
	*/
	...
	ListKeypairsExecute(r ApiListKeypairsRequest) (*ListKeypairsResponse, *http.Response, error)
}
...
func (r ApiCreateKeypairRequest) Execute() (*CreateKeypairResponse, *http.Response, error) {
...
//
//	@return CreateKeypairResponse
func (a *KeypairAPIService) CreateKeypairExecute(r ApiCreateKeypairRequest) (*CreateKeypairResponse, *http.Response, error) {
	var (
	...
	if r.createKeypairRequest == nil {
		return localVarReturnValue, nil, reportError("createKeypairRequest is required and must be specified")
	}
...
func (r ApiGetKeypairRequest) Execute() (*GetKeypairResponse, *http.Response, error) {
...
//
//	@return GetKeypairResponse
func (a *KeypairAPIService) GetKeypairExecute(r ApiGetKeypairRequest) (*GetKeypairResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetKeypairResponse
	)
...
func (r ApiListKeypairsRequest) Execute() (*ListKeypairsResponse, *http.Response, error) {
...
//
//	@return ListKeypairsResponse
func (a *KeypairAPIService) ListKeypairsExecute(r ApiListKeypairsRequest) (*ListKeypairsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListKeypairsResponse
	)
