...
------------ | ------------- | ------------- | -------------
**Id** | **string** | 변경할 인스턴스 유형 ID &lt;br/&gt; - [List instance types](https://docs.kakaocloud.com/openapi/bcs/list-instance-types)에서 확인 &lt;br/&gt; - [인스턴스 유형별 사양](https://docs.kakaocloud.com/service/bcs/bcs-specifications) 참고 | 
