...
// checks if the BcsInstanceV1ApiListInstanceTypesModelFlavorModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BcsInstanceV1ApiListInstanceTypesModelFlavorModel{}

// BcsInstanceV1ApiListInstanceTypesModelFlavorModel struct for BcsInstanceV1ApiListInstanceTypesModelFlavorModel
type BcsInstanceV1ApiListInstanceTypesModelFlavorModel struct {
	// 인스턴스 유형 ID
	Id                               string               `json:"id"`
...
type _BcsInstanceV1ApiListInstanceTypesModelFlavorModel BcsInstanceV1ApiListInstanceTypesModelFlavorModel
...
func NewBcsInstanceV1ApiListInstanceTypesModelFlavorModel(id string) *BcsInstanceV1ApiListInstanceTypesModelFlavorModel {
	this := BcsInstanceV1ApiListInstanceTypesModelFlavorModel{}
	this.Id = id
	return &this
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetVcpusNil() {
	o.Vcpus.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetDescriptionNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetIsBurstableNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetArchitectureNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetManufacturerNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetInstanceTypeNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetProcessorNil() {
	o.Processor.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetMemoryMbNil() {
	o.MemoryMb.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetInstanceFamilyNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetInstanceSizeNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetDiskTypeNil() {
	o.DiskType.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetRootGbNil() {
	o.RootGb.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetOsDistroNil() {
	o.OsDistro.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetHwCountNil() {
	o.HwCount.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetHwTypeNil() {
	o.HwType.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetHwNameNil() {
	o.HwName.Set(nil)
}
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetMaximumNetworkInterfacesNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetIsHyperThreadingDisabledNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetIsHyperThreadingSupportedNil() {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) SetIsHyperThreadingDisableSupportedNil() {
...
func (o BcsInstanceV1ApiListInstanceTypesModelFlavorModel) MarshalJSON() ([]byte, error) {
...
func (o BcsInstanceV1ApiListInstanceTypesModelFlavorModel) ToMap() (map[string]interface{}, error) {
...
func (o *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBcsInstanceV1ApiListInstanceTypesModelFlavorModel := _BcsInstanceV1ApiListInstanceTypesModelFlavorModel{}

	err = json.Unmarshal(data, &varBcsInstanceV1ApiListInstanceTypesModelFlavorModel)

	if err != nil {
		return err
	}

	*o = BcsInstanceV1ApiListInstanceTypesModelFlavorModel(varBcsInstanceV1ApiListInstanceTypesModelFlavorModel)
...
type NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel struct {
	value *BcsInstanceV1ApiListInstanceTypesModelFlavorModel
	isSet bool
}

func (v NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) Get() *BcsInstanceV1ApiListInstanceTypesModelFlavorModel {
	return v.value
}

func (v *NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) Set(val *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel(val *BcsInstanceV1ApiListInstanceTypesModelFlavorModel) *NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel {
	return &NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel{value: val, isSet: true}
}

func (v NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBcsInstanceV1ApiListInstanceTypesModelFlavorModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
