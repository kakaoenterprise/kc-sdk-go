...
type CreateInstance struct {
	...
	// 인스턴스 유형 ID <br/> - [List instance types](/openapi/bcs/list-instance-types)에서 확인
	FlavorId         string                   `json:"flavor_id"`
	AvailabilityZone NullableAvailabilityZone `json:"availability_zone,omitempty"`
	// 연결할 서브넷 정보 목록
	Subnets                 []SubnetRequest             `json:"subnets"`
	Volumes                 []BlockDeviceMappingRequest `json:"volumes,omitempty"`
	KeyName                 NullableString              `json:"key_name,omitempty"`
	SecurityGroups          []SecurityGroupRequest      `json:"security_groups,omitempty"`
	...
	IsBonding               NullableBool                `json:"is_bonding,omitempty"`
...
func (o *CreateInstance) SetDescriptionNil() {
...
func (o *CreateInstance) SetAvailabilityZoneNil() {
...
func (o *CreateInstance) GetVolumes() []BlockDeviceMappingRequest {
	if o == nil {
		var ret []BlockDeviceMappingRequest
		return ret
	}
	return o.Volumes
}
...
// SetVolumes gets a reference to the given []BlockDeviceMappingRequest and assigns it to the Volumes field.
...
func (o *CreateInstance) SetKeyNameNil() {
	o.KeyName.Set(nil)
}
...
// SetSecurityGroups gets a reference to the given []SecurityGroupRequest and assigns it to the SecurityGroups field.
...
func (o *CreateInstance) SetUserDataNil() {
	o.UserData.Set(nil)
}
...
func (o *CreateInstance) SetIsDisableHyperThreadingNil() {
...
// GetIsBonding returns the IsBonding field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateInstance) GetIsBonding() bool {
	if o == nil || IsNil(o.IsBonding.Get()) {
		var ret bool
		return ret
	}
	return *o.IsBonding.Get()
}
...
// SetIsBonding gets a reference to the given NullableBool and assigns it to the IsBonding field.
func (o *CreateInstance) SetIsBonding(v bool) {
	o.IsBonding.Set(&v)
}

// SetIsBondingNil sets the value for IsBonding to be an explicit nil
func (o *CreateInstance) SetIsBondingNil() {
	o.IsBonding.Set(nil)
}
...
func (o CreateInstance) ToMap() (map[string]interface{}, error) {
	...
	if o.IsBonding.IsSet() {
		toSerialize["is_bonding"] = o.IsBonding.Get()
	}
