...
type ImageAPI interface {
	...
	:::info 안내
	- 프로젝트 관리자(Admin) 또는 프로젝트 멤버(Member) 권한을 가진 사용자가 이미지 공유 및 공유 해제를 수행할 수 있습니다.
	- 공유 추가 후 공유 대상 프로젝트 목록은 [List image shared projects](/openapi/bcs/list-image-shared-projects)에서 확인할 수 있습니다.
	:::

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param imageId 이미지의 고유 ID <br/> - [List images](/openapi/bcs/list-images)에서 확인
	...
	*/
	...
	//  @return AddImageShareResponse
	AddImageShareExecute(r ApiAddImageShareRequest) (*AddImageShareResponse, *http.Response, error)
	...
	:::caution 주의
	- 삭제된 이미지는 복구할 수 없습니다.
	- 삭제된 이미지는 시스템에서 완전히 제거되며, 이 이미지에 대한 모든 참조도 함께 삭제됩니다.
	- 사용 중인 이미지도 삭제할 수 있으며, 삭제 이후에도 해당 이미지를 기반으로 이미 생성된 인스턴스는 함께 삭제되지 않습니다.
	:::
	...
	*/
	...
	GetImageExecute(r ApiGetImageRequest) (*GetImageResponse, *http.Response, error)
	...
	:::info 안내
	이미지의 공유 대상 정보는 해당 이미지에 접근 권한이 있는 사용자만 조회할 수 있습니다. 조회 권한이 있는 역할은 프로젝트 멤버(Member), 프로젝트 관리자(Admin), 프로젝트 리더(Reader)입니다.
	:::
	...
	*/
	...
	//  @return ListImageSharedProjectsResponse
	ListImageSharedProjectsExecute(r ApiListImageSharedProjectsRequest) (*ListImageSharedProjectsResponse, *http.Response, error)

	/*
		ListImages List images

		사용자가 클라우드 환경에서 사용 가능한 운영체제(OS)의 이미지 목록을 조회합니다.
	...
	*/
	...
	ListImagesExecute(r ApiListImagesRequest) (*ListImagesResponse, *http.Response, error)
	...
	:::
		...
		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param imageId 이미지의 고유 ID <br/> - [List images](/openapi/bcs/list-images)에서 확인
		@param memberId 공유 대상 프로젝트 ID <br/> - [List image shared projects](/openapi/bcs/list-image-shared-projects)에서 확인
	...
	*/
	...
	UpdateImageExecute(r ApiUpdateImageRequest) (*UpdateImageResponse, *http.Response, error)
}
...
func (r ApiAddImageShareRequest) Execute() (*AddImageShareResponse, *http.Response, error) {
...
//
//	@return AddImageShareResponse
func (a *ImageAPIService) AddImageShareExecute(r ApiAddImageShareRequest) (*AddImageShareResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddImageShareResponse
	)
...
//
//	@return GetImageResponse
func (a *ImageAPIService) GetImageExecute(r ApiGetImageRequest) (*GetImageResponse, *http.Response, error) {
	var (
...
func (r ApiListImageSharedProjectsRequest) Execute() (*ListImageSharedProjectsResponse, *http.Response, error) {
...
//
//	@return ListImageSharedProjectsResponse
func (a *ImageAPIService) ListImageSharedProjectsExecute(r ApiListImageSharedProjectsRequest) (*ListImageSharedProjectsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListImageSharedProjectsResponse
	)
...
// 이미지 제공 유형
func (r ApiListImagesRequest) ImageType(imageType ImageType) ApiListImagesRequest {
...
//
//	@return ListImagesResponse
func (a *ImageAPIService) ListImagesExecute(r ApiListImagesRequest) (*ListImagesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateImageRequest) Execute() (*UpdateImageResponse, *http.Response, error) {
...
//
//	@return UpdateImageResponse
func (a *ImageAPIService) UpdateImageExecute(r ApiUpdateImageRequest) (*UpdateImageResponse, *http.Response, error) {
	var (
	...
	if r.updateImageRequest == nil {
		return localVarReturnValue, nil, reportError("updateImageRequest is required and must be specified")
	}
