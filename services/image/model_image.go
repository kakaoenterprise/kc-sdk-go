...
type Image struct {
	...
	OsInfo               NullableOsInfo            `json:"os_info,omitempty"`
...
func (o *Image) SetImageMemberStatusNil() {
...
// SetOsInfo gets a reference to the given NullableOsInfo and assigns it to the OsInfo field.
func (o *Image) SetOsInfo(v OsInfo) {
	o.OsInfo.Set(&v)
}

// SetOsInfoNil sets the value for OsInfo to be an explicit nil
func (o *Image) SetOsInfoNil() {
	o.OsInfo.Set(nil)
}
