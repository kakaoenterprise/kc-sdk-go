...
> CreateDataKeyResponse CreateDataKey(ctx, keyId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	resp, r, err := apiClient.PublicKeyAPI.CreateDataKey(context.Background(), keyId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> DecryptDataResponse DecryptData(ctx, keyId).XAuthToken(xAuthToken).DecryptDataRequest(decryptDataRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.DecryptData(context.Background(), keyId).XAuthToken(xAuthToken).DecryptDataRequest(decryptDataRequest).Execute()
	if err != nil {
...
> EncryptDataResponse EncryptData(ctx, keyId).XAuthToken(xAuthToken).EncryptDataRequest(encryptDataRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.EncryptData(context.Background(), keyId).XAuthToken(xAuthToken).EncryptDataRequest(encryptDataRequest).Execute()
	if err != nil {
...
> GenerateHmacResponse GenerateHmac(ctx, keyId).XAuthToken(xAuthToken).GenerateHmacRequest(generateHmacRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.GenerateHmac(context.Background(), keyId).XAuthToken(xAuthToken).GenerateHmacRequest(generateHmacRequest).Execute()
	if err != nil {
...
> SignDataResponse SignData(ctx, keyId).XAuthToken(xAuthToken).SignDataRequest(signDataRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.SignData(context.Background(), keyId).XAuthToken(xAuthToken).SignDataRequest(signDataRequest).Execute()
	if err != nil {
...
> VerifyHmacResponse VerifyHmac(ctx, keyId).XAuthToken(xAuthToken).VerifyHmacRequest(verifyHmacRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.VerifyHmac(context.Background(), keyId).XAuthToken(xAuthToken).VerifyHmacRequest(verifyHmacRequest).Execute()
	if err != nil {
...
> VerifySignatureResponse VerifySignature(ctx, keyId).XAuthToken(xAuthToken).VerifySignatureRequest(verifySignatureRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PublicKeyAPI.VerifySignature(context.Background(), keyId).XAuthToken(xAuthToken).VerifySignatureRequest(verifySignatureRequest).Execute()
	if err != nil {
