...
func NewSign(signature string) *Sign {
	this := Sign{}
...
func (o *Sign) GetSignature() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *Sign) GetSignatureOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Sign) SetSignature(v string) {
	o.Signature = v
}
...
func (o *Sign) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSign)
