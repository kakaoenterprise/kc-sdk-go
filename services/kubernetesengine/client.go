...
// APIClient manages communication with the kubernetes-engine API API v0.1.0
...
type APIClient struct {
	...
	ServiceAgentsAPI ServiceAgentsAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ServiceAgentsAPI = (*ServiceAgentsAPIService)(&c.common)
