...
**Labels** | Pointer to [**[]LabelRequest**](LabelRequest.md) |  | [optional] 
**Taints** | Pointer to [**[]TaintRequest**](TaintRequest.md) |  | [optional] 
**UserData** | Pointer to **NullableString** |  | [optional] 
**VpcInfo** | [**VpcInfoRequest**](VpcInfoRequest.md) | 노드 풀을 생성할 VPC 정보 | 
**ImageId** | **string** | 이미지의 고유 ID &lt;br/&gt;- [List node pool images](https://docs.kakaocloud.com/openapi/container-pack/k8se/list-node-pool-images)에서 확인 | 
