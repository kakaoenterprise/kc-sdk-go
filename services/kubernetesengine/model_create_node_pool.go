...
// checks if the CreateNodePool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNodePool{}

// CreateNodePool struct for CreateNodePool
type CreateNodePool struct {
	...
	// 이미지의 고유 ID <br/>- [List node pool images](/openapi/container-pack/k8se/list-node-pool-images)에서 확인
...
type _CreateNodePool CreateNodePool
...
func (o *CreateNodePool) SetDescriptionNil() {
...
func (o *CreateNodePool) SetVolumeSizeNil() {
...
// SetLabels gets a reference to the given []LabelRequest and assigns it to the Labels field.
...
// SetTaints gets a reference to the given []TaintRequest and assigns it to the Taints field.
...
func (o *CreateNodePool) SetUserDataNil() {
	o.UserData.Set(nil)
}
...
func (o *CreateNodePool) SetIsHyperThreadingNil() {
...
func (o CreateNodePool) MarshalJSON() ([]byte, error) {
...
func (o CreateNodePool) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNodePool) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNodePool := _CreateNodePool{}

	err = json.Unmarshal(data, &varCreateNodePool)

	if err != nil {
		return err
	}

	*o = CreateNodePool(varCreateNodePool)
...
type NullableCreateNodePool struct {
	value *CreateNodePool
	isSet bool
}

func (v NullableCreateNodePool) Get() *CreateNodePool {
	return v.value
}

func (v *NullableCreateNodePool) Set(val *CreateNodePool) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNodePool) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNodePool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNodePool(val *CreateNodePool) *NullableCreateNodePool {
	return &NullableCreateNodePool{value: val, isSet: true}
}

func (v NullableCreateNodePool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNodePool) UnmarshalJSON(src []byte) error {
	v.isSet = true
