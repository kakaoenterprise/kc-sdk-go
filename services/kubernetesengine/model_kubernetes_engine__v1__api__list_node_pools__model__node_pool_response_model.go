...
// checks if the KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel{}

// KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel struct for KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel
type KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel struct {
	// 노드 풀의 리소스 기반 오토스케일링 설정 정보
	Autoscaling KubernetesEngineV1ApiListNodePoolsModelAutoscalingResponseModel `json:"autoscaling"`
	// 베어메탈 유형 노드 풀 여부
	...
	// 노드 풀 상태
	Status KubernetesEngineV1ApiListNodePoolsModelStatusInfoResponseModel `json:"status"`
	// 노드 풀이 가진 테인트 목록
	Taints []KubernetesEngineV1ApiListNodePoolsModelTaintInfoResponseModel `json:"taints"`
	// 업그레이드 가능 여부
	...
	// 노드 풀이 속한 VPC 정보
	VpcInfo KubernetesEngineV1ApiListNodePoolsModelVpcInfoResponseModel `json:"vpc_info"`
	// 하이퍼스레딩 사용 여부
	IsHyperThreading     bool `json:"is_hyper_threading"`
	AdditionalProperties map[string]interface{}
}

type _KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel
...
func NewKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel(autoscaling KubernetesEngineV1ApiListNodePoolsModelAutoscalingResponseModel, isBareMetal bool, clusterName string, isCordon bool, nodeCount int32, createdAt time.Time, description string, flavor string, flavorId string, isGpu bool, id string, image ImageInfoResponseModel, labels []LabelInfoResponseModel, name string, securityGroups []string, sshKeyName string, status KubernetesEngineV1ApiListNodePoolsModelStatusInfoResponseModel, taints []KubernetesEngineV1ApiListNodePoolsModelTaintInfoResponseModel, isUpgradable bool, version string, volumeSize int32, vpcInfo KubernetesEngineV1ApiListNodePoolsModelVpcInfoResponseModel, isHyperThreading bool) *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel {
	this := KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel{}
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) GetAutoscaling() KubernetesEngineV1ApiListNodePoolsModelAutoscalingResponseModel {
	if o == nil {
		var ret KubernetesEngineV1ApiListNodePoolsModelAutoscalingResponseModel
		return ret
	}
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) SetFailureMessageNil() {
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) GetStatus() KubernetesEngineV1ApiListNodePoolsModelStatusInfoResponseModel {
	if o == nil {
		var ret KubernetesEngineV1ApiListNodePoolsModelStatusInfoResponseModel
		return ret
	}
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) GetTaints() []KubernetesEngineV1ApiListNodePoolsModelTaintInfoResponseModel {
	if o == nil {
		var ret []KubernetesEngineV1ApiListNodePoolsModelTaintInfoResponseModel
		return ret
	}
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) SetUserDataNil() {
	o.UserData.Set(nil)
}
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) GetVpcInfo() KubernetesEngineV1ApiListNodePoolsModelVpcInfoResponseModel {
	if o == nil {
		var ret KubernetesEngineV1ApiListNodePoolsModelVpcInfoResponseModel
		return ret
	}
...
func (o KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) MarshalJSON() ([]byte, error) {
...
func (o KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) UnmarshalJSON(data []byte) (err error) {
	...
	varKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel := _KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel{}

	err = json.Unmarshal(data, &varKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel)

	if err != nil {
		return err
	}

	*o = KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel(varKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel)
...
type NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel struct {
	value *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel
	isSet bool
}

func (v NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) Get() *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel {
	return v.value
}

func (v *NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) Set(val *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel(val *KubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) *NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel {
	return &NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel{value: val, isSet: true}
}

func (v NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesEngineV1ApiListNodePoolsModelNodePoolResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
