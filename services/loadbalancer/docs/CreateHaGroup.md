...
**TypeId** | **string** | 사용할 로드 밸런서 유형 ID &lt;br/&gt;- [List load balancer types](https://docs.kakaocloud.com/openapi/networking/lb/list-load-balancer-types)에서 확인 | 
**Scheme** | [**BeyondLoadBalancerScheme**](BeyondLoadBalancerScheme.md) | 로드 밸런서 통신 방식 | 
**VpcId** | **string** | 고가용성 그룹이 소속될 VPC의 ID &lt;br/&gt;- [List VPCs](https://docs.kakaocloud.com/openapi/networking/vpc/list-vpcs)에서 확인 | 
