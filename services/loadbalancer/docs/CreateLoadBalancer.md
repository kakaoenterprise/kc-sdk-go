...
**SubnetId** | **string** | 로드 밸런서를 배치할 서브넷 ID &lt;br/&gt;- [List subnets](https://docs.kakaocloud.com/openapi/networking/vpc/list-subnets)에서 확인 | 
**AvailabilityZone** | [**AvailabilityZone**](AvailabilityZone.md) | 로드 밸런서를 생성할 가용 영역 | 
**FlavorId** | **string** | 로드 밸런서 유형 ID &lt;br/&gt;- &#x60;flavors.id&#x60; 값은 [List load balancer types](https://docs.kakaocloud.com/openapi/networking/lb/list-load-balancer-types)에서 확인 | 
**Listeners** | Pointer to [**[]CreateLoadBalancerListenerRequest**](CreateLoadBalancerListenerRequest.md) |  | [optional] 
**TargetGroups** | Pointer to [**[]CreateLoadBalancerPoolRequest**](CreateLoadBalancerPoolRequest.md) |  | [optional] 
