...
> CreateHealthMonitorResponse CreateHealthMonitor(ctx).XAuthToken(xAuthToken).CreateHealthMonitorRequest(createHealthMonitorRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.HealthMonitorAPI.CreateHealthMonitor(context.Background()).XAuthToken(xAuthToken).CreateHealthMonitorRequest(createHealthMonitorRequest).Execute()
	if err != nil {
...
func main() {
	healthMonitorId := "healthMonitorId_example" // string | 삭제할 헬스 모니터의 ID <br/>- [List target groups](https://docs.kakaocloud.com/openapi/networking/lb/list-target-groups)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.HealthMonitorAPI.DeleteHealthMonitor(context.Background(), healthMonitorId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
**healthMonitorId** | **string** | 삭제할 헬스 모니터의 ID &lt;br/&gt;- [List target groups](https://docs.kakaocloud.com/openapi/networking/lb/list-target-groups)에서 확인 | 
...
> GetTargetGroupHealthCheckSubnetsResponse GetTargetGroupHealthCheckSubnets(ctx, targetGroupId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.HealthMonitorAPI.GetTargetGroupHealthCheckSubnets(context.Background(), targetGroupId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> GetTargetGroupHealthMonitorResponse GetTargetGroupHealthMonitor(ctx, healthMonitorId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.HealthMonitorAPI.GetTargetGroupHealthMonitor(context.Background(), healthMonitorId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> UpdateHealthMonitorResponse UpdateHealthMonitor(ctx, healthMonitorId).XAuthToken(xAuthToken).UpdateHealthMonitorRequest(updateHealthMonitorRequest).Execute()
...
func main() {
	healthMonitorId := "healthMonitorId_example" // string | 수정 대상 헬스 모니터의 ID <br/>- [List target groups](https://docs.kakaocloud.com/openapi/networking/lb/list-target-groups)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.HealthMonitorAPI.UpdateHealthMonitor(context.Background(), healthMonitorId).XAuthToken(xAuthToken).UpdateHealthMonitorRequest(updateHealthMonitorRequest).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**healthMonitorId** | **string** | 수정 대상 헬스 모니터의 ID &lt;br/&gt;- [List target groups](https://docs.kakaocloud.com/openapi/networking/lb/list-target-groups)에서 확인 | 
