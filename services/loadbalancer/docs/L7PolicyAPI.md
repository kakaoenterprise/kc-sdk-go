...
> CreateL7PolicyResponse CreateL7Policy(ctx).XAuthToken(xAuthToken).CreateL7PolicyRequest(createL7PolicyRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.L7PolicyAPI.CreateL7Policy(context.Background()).XAuthToken(xAuthToken).CreateL7PolicyRequest(createL7PolicyRequest).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.L7PolicyAPI.DeleteL7Policy(context.Background(), l7policyId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> GetL7PolicyResponse GetL7Policy(ctx, l7policyId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.L7PolicyAPI.GetL7Policy(context.Background(), l7policyId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> ListL7PoliciesResponse ListL7Policies(ctx, loadBalancerId, listenerId).XAuthToken(xAuthToken).Id(id).Position(position).Action(action).ProvisioningStatus(provisioningStatus).OperatingStatus(operatingStatus).Name(name).SortKeys(sortKeys).SortDirs(sortDirs).Offset(offset).Limit(limit).Execute()
...
func main() {
	loadBalancerId := "loadBalancerId_example" // string | 조회할 로드 밸런서 ID <br/>- [List load balancers](https://docs.kakaocloud.com/openapi/networking/lb/list-load-balancers)에서 확인
	listenerId := "listenerId_example" // string | 조회할 리스너 ID <br/>- [List listeners](https://docs.kakaocloud.com/openapi/networking/lb/list-listeners)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.L7PolicyAPI.ListL7Policies(context.Background(), loadBalancerId, listenerId).XAuthToken(xAuthToken).Id(id).Position(position).Action(action).ProvisioningStatus(provisioningStatus).OperatingStatus(operatingStatus).Name(name).SortKeys(sortKeys).SortDirs(sortDirs).Offset(offset).Limit(limit).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**loadBalancerId** | **string** | 조회할 로드 밸런서 ID &lt;br/&gt;- [List load balancers](https://docs.kakaocloud.com/openapi/networking/lb/list-load-balancers)에서 확인 | 
**listenerId** | **string** | 조회할 리스너 ID &lt;br/&gt;- [List listeners](https://docs.kakaocloud.com/openapi/networking/lb/list-listeners)에서 확인 | 
...
> UpdateL7PolicyResponse UpdateL7Policy(ctx, l7policyId).XAuthToken(xAuthToken).UpdateL7PolicyRequest(updateL7PolicyRequest).Execute()
...
func main() {
	l7policyId := "l7policyId_example" // string | 수정할 대상 L7 정책의 ID <br/>- [List L7 policies](https://docs.kakaocloud.com/openapi/networking/lb/list-l-7-policies)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.L7PolicyAPI.UpdateL7Policy(context.Background(), l7policyId).XAuthToken(xAuthToken).UpdateL7PolicyRequest(updateL7PolicyRequest).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**l7policyId** | **string** | 수정할 대상 L7 정책의 ID &lt;br/&gt;- [List L7 policies](https://docs.kakaocloud.com/openapi/networking/lb/list-l-7-policies)에서 확인 | 
