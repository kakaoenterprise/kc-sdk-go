...
// checks if the AddL7PolicyRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddL7PolicyRule{}

// AddL7PolicyRule struct for AddL7PolicyRule
type AddL7PolicyRule struct {
	// 규칙 값 비교 방식
...
type _AddL7PolicyRule AddL7PolicyRule
...
func (o *AddL7PolicyRule) SetIsInvertedNil() {
...
func (o *AddL7PolicyRule) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o AddL7PolicyRule) MarshalJSON() ([]byte, error) {
...
func (o AddL7PolicyRule) ToMap() (map[string]interface{}, error) {
...
func (o *AddL7PolicyRule) UnmarshalJSON(data []byte) (err error) {
	...
	varAddL7PolicyRule := _AddL7PolicyRule{}

	err = json.Unmarshal(data, &varAddL7PolicyRule)

	if err != nil {
		return err
	}

	*o = AddL7PolicyRule(varAddL7PolicyRule)
...
type NullableAddL7PolicyRule struct {
	value *AddL7PolicyRule
	isSet bool
}

func (v NullableAddL7PolicyRule) Get() *AddL7PolicyRule {
	return v.value
}

func (v *NullableAddL7PolicyRule) Set(val *AddL7PolicyRule) {
	v.value = val
	v.isSet = true
}

func (v NullableAddL7PolicyRule) IsSet() bool {
	return v.isSet
}

func (v *NullableAddL7PolicyRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddL7PolicyRule(val *AddL7PolicyRule) *NullableAddL7PolicyRule {
	return &NullableAddL7PolicyRule{value: val, isSet: true}
}

func (v NullableAddL7PolicyRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddL7PolicyRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
