...
// checks if the AvailabilityZoneInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneInfo{}

// AvailabilityZoneInfo struct for AvailabilityZoneInfo
...
type _AvailabilityZoneInfo AvailabilityZoneInfo
...
func (o *AvailabilityZoneInfo) SetDescriptionNil() {
...
func (o *AvailabilityZoneInfo) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o AvailabilityZoneInfo) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneInfo) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneInfo := _AvailabilityZoneInfo{}

	err = json.Unmarshal(data, &varAvailabilityZoneInfo)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneInfo(varAvailabilityZoneInfo)
...
type NullableAvailabilityZoneInfo struct {
	value *AvailabilityZoneInfo
	isSet bool
}

func (v NullableAvailabilityZoneInfo) Get() *AvailabilityZoneInfo {
	return v.value
}

func (v *NullableAvailabilityZoneInfo) Set(val *AvailabilityZoneInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneInfo(val *AvailabilityZoneInfo) *NullableAvailabilityZoneInfo {
	return &NullableAvailabilityZoneInfo{value: val, isSet: true}
}

func (v NullableAvailabilityZoneInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
