...
// checks if the BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel{}

// BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel struct for BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel
type BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel struct {
	// 생성된 정책의 ID
	Id                 string                              `json:"id"`
	...
	Rules                 []BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel `json:"rules,omitempty"`
	CreatedAt             NullableTime                                       `json:"created_at,omitempty"`
	UpdatedAt             NullableTime                                       `json:"updated_at,omitempty"`
	AdditionalProperties  map[string]interface{}
}

type _BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel
...
func NewBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel(id string, action L7PolicyAction, listenerId string) *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel {
	this := BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel{}
	this.Id = id
	this.Action = action
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetDescriptionNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetRedirectTargetGroupIdNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetRedirectUrlNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetRedirectPrefixNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) GetRules() []BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel {
	if o == nil {
		var ret []BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel and assigns it to the Rules field.
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel := _BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel(varBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel)
...
type NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel struct {
	value *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) Get() *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) Set(val *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel(val *BnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel {
	return &NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelL7PolicyModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
