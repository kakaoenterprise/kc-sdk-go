...
// checks if the BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel{}

// BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel struct for BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel
type BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel struct {
	// L7 규칙의 고유 ID
	Id          string                    `json:"id"`
...
type _BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel
...
func NewBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel {
	this := BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel := _BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel(varBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel)
...
type NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel struct {
	value *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) Get() *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) Set(val *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel(val *BnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel {
	return &NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiCreateL7PolicyModelRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
