...
// checks if the BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel{}

// BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel struct for BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel
type BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel struct {
	// L7 규칙 ID
	Id          string                    `json:"id"`
...
type _BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel
...
func NewBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel {
	this := BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel := _BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel(varBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel)
...
type NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel struct {
	value *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) Get() *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) Set(val *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel(val *BnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) *NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel {
	return &NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyModelRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
