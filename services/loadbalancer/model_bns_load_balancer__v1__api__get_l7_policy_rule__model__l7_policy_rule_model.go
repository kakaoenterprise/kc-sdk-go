...
// checks if the BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel{}

// BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel struct for BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel
type BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel struct {
	// L7 규칙 ID
	Id          string                    `json:"id"`
...
type _BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel
...
func NewBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel {
	this := BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel := _BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel(varBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel)
...
type NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel struct {
	value *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) Get() *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) Set(val *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel(val *BnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) *NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel {
	return &NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiGetL7PolicyRuleModelL7PolicyRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
