...
// checks if the BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel{}

// BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel struct for BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel
type BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel struct {
	// L7 정책 ID
	Id                    string                                          `json:"id"`
	...
	Rules                 []BnsLoadBalancerV1ApiGetListenerModelRuleModel `json:"rules,omitempty"`
...
type _BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel
...
func NewBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel(id string) *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel {
	this := BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel{}
	this.Id = id
	return &this
}
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetDescriptionNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetActionNil() {
	o.Action.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) GetRules() []BnsLoadBalancerV1ApiGetListenerModelRuleModel {
	if o == nil {
		var ret []BnsLoadBalancerV1ApiGetListenerModelRuleModel
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []BnsLoadBalancerV1ApiGetListenerModelRuleModel and assigns it to the Rules field.
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetRedirectTargetGroupIdNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetRedirectUrlNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetRedirectPrefixNil() {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) SetRedirectHttpCodeNil() {
...
func (o BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel := _BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel(varBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel)
...
type NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel struct {
	value *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) Get() *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) Set(val *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel(val *BnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) *NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel {
	return &NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiGetListenerModelL7PolicyModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
