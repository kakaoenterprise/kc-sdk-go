...
// checks if the BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel{}

// BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel struct for BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel
type BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel struct {
	// 로드 밸런서 ID
	Id                        string                              `json:"id"`
...
type _BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel
...
func NewBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel(id string) *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel {
	this := BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel{}
	this.Id = id
	return &this
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetDescriptionNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetAvailabilityZoneNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetAccessLogsNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetBeyondLoadBalancerIdNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetBeyondLoadBalancerNameNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetBeyondLoadBalancerDnsNameNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetTargetGroupCountNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetListenerCountNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetPrivateVipNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetPublicVipNil() {
	o.PublicVip.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetSubnetNameNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetSubnetCidrBlockNil() {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetVpcIdNil() {
	o.VpcId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetVpcNameNil() {
	o.VpcName.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) SetSubnetIdNil() {
	o.SubnetId.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel := _BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel(varBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel)
...
type NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel struct {
	value *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) Get() *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) Set(val *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel(val *BnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) *NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel {
	return &NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiGetLoadBalancerModelLoadBalancerModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
