...
// checks if the BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel{}

// BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel struct for BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel
type BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel struct {
	// L7 정책 ID
	Id                    string                                             `json:"id"`
	...
	Rules                 []BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel `json:"rules,omitempty"`
...
type _BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel
...
func NewBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel(id string) *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel {
	this := BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel{}
	this.Id = id
	return &this
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetDescriptionNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetActionNil() {
	o.Action.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) GetRules() []BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel {
	if o == nil {
		var ret []BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel and assigns it to the Rules field.
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetRedirectTargetGroupIdNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetRedirectUrlNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetRedirectPrefixNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) SetRedirectHttpCodeNil() {
...
func (o BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel := _BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel(varBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel)
...
type NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel struct {
	value *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) Get() *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) Set(val *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel(val *BnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) *NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel {
	return &NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelL7PolicyModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
