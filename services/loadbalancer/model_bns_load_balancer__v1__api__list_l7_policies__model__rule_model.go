...
// checks if the BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel{}

// BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel struct for BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel
type BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel struct {
	// L7 규칙 ID
	Id          string                    `json:"id"`
...
type _BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel
...
func NewBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel {
	this := BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel := _BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel(varBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel)
...
type NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel struct {
	value *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) Get() *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) Set(val *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel(val *BnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) *NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel {
	return &NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiListL7PoliciesModelRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
