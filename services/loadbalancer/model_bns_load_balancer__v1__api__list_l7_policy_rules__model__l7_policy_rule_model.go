...
// checks if the BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel{}

// BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel struct for BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel
type BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel struct {
	// 규칙 ID
	Id          string                    `json:"id"`
...
type _BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel
...
func NewBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel {
	this := BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel := _BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel(varBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel)
...
type NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel struct {
	value *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) Get() *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) Set(val *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel(val *BnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) *NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel {
	return &NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiListL7PolicyRulesModelL7PolicyRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
