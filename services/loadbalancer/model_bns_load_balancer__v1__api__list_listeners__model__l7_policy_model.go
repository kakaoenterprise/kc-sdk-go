...
// checks if the BnsLoadBalancerV1ApiListListenersModelL7PolicyModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiListListenersModelL7PolicyModel{}

// BnsLoadBalancerV1ApiListListenersModelL7PolicyModel struct for BnsLoadBalancerV1ApiListListenersModelL7PolicyModel
type BnsLoadBalancerV1ApiListListenersModelL7PolicyModel struct {
	// L7 정책의 ID
	Id                    string                                            `json:"id"`
	...
	Rules                 []BnsLoadBalancerV1ApiListListenersModelRuleModel `json:"rules,omitempty"`
...
type _BnsLoadBalancerV1ApiListListenersModelL7PolicyModel BnsLoadBalancerV1ApiListListenersModelL7PolicyModel
...
func NewBnsLoadBalancerV1ApiListListenersModelL7PolicyModel(id string) *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel {
	this := BnsLoadBalancerV1ApiListListenersModelL7PolicyModel{}
	this.Id = id
	return &this
}
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetDescriptionNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetActionNil() {
	o.Action.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) GetRules() []BnsLoadBalancerV1ApiListListenersModelRuleModel {
	if o == nil {
		var ret []BnsLoadBalancerV1ApiListListenersModelRuleModel
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []BnsLoadBalancerV1ApiListListenersModelRuleModel and assigns it to the Rules field.
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetRedirectTargetGroupIdNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetRedirectUrlNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetRedirectPrefixNil() {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) SetRedirectHttpCodeNil() {
...
func (o BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiListListenersModelL7PolicyModel := _BnsLoadBalancerV1ApiListListenersModelL7PolicyModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiListListenersModelL7PolicyModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiListListenersModelL7PolicyModel(varBnsLoadBalancerV1ApiListListenersModelL7PolicyModel)
...
type NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel struct {
	value *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) Get() *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) Set(val *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel(val *BnsLoadBalancerV1ApiListListenersModelL7PolicyModel) *NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel {
	return &NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiListListenersModelL7PolicyModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
