...
// checks if the BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel{}

// BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel struct for BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel
type BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel struct {
	// 규칙 ID
	Id          string                    `json:"id"`
	...
	Value              NullableL7RuleCompareType           `json:"value,omitempty"`
...
type _BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel
...
func NewBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel(id string, isInverted bool, projectId string) *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel {
	this := BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel{}
	this.Id = id
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetCompareTypeNil() {
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
// SetValue gets a reference to the given NullableL7RuleCompareType and assigns it to the Value field.
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetValue(v L7RuleCompareType) {
	o.Value.Set(&v)
}

// SetValueNil sets the value for Value to be an explicit nil
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetProvisioningStatusNil() {
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetOperatingStatusNil() {
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel := _BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel(varBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel)
...
type NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel struct {
	value *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) Get() *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) Set(val *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel(val *BnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) *NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel {
	return &NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyModelRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
