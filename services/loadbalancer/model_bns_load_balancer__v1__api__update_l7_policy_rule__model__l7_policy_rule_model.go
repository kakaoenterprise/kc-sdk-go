...
// checks if the BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel{}

// BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel struct for BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel
type BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel struct {
	// L7 규칙의 ID
	Id string `json:"id"`
...
type _BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel
...
func NewBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel(id string, type_ L7RuleType, compareType L7RuleCompareType, value string, isInverted bool, provisioningStatus ProvisioningStatus, operatingStatus LoadBalancerOperatingStatus, createdAt time.Time) *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel {
	this := BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel{}
	this.Id = id
	this.Type = type_
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel := _BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel(varBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel)
...
type NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel struct {
	value *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) Get() *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) Set(val *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel(val *BnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) *NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel {
	return &NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiUpdateL7PolicyRuleModelL7PolicyRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
