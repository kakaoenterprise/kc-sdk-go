...
// checks if the BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel{}

// BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel struct for BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel
type BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel struct {
...
type _BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel
...
func NewBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel(type_ string, cookieName string, persistenceTimeout int32, persistenceGranularity string) *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel {
	this := BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel{}
	this.Type = type_
...
func (o BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) MarshalJSON() ([]byte, error) {
...
func (o BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel := _BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel{}

	err = json.Unmarshal(data, &varBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel)

	if err != nil {
		return err
	}

	*o = BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel(varBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel)
...
type NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel struct {
	value *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel
	isSet bool
}

func (v NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) Get() *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel {
	return v.value
}

func (v *NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) Set(val *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel(val *BnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) *NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel {
	return &NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel{value: val, isSet: true}
}

func (v NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsLoadBalancerV1ApiUpdateTargetGroupModelSessionPersistenceModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
