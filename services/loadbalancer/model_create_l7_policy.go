...
// checks if the CreateL7Policy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateL7Policy{}

// CreateL7Policy struct for CreateL7Policy
type CreateL7Policy struct {
	Name NullableString `json:"name,omitempty"`
	// 정책 동작 유형
	Action      L7PolicyAction `json:"action"`
	Description NullableString `json:"description,omitempty"`
	// 정책을 적용할 대상 리스너 ID <br/>- [List listeners](/openapi/networking/lb/list-listeners)에서 확인
...
type _CreateL7Policy CreateL7Policy
...
func (o *CreateL7Policy) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CreateL7Policy) SetDescriptionNil() {
...
func (o *CreateL7Policy) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *CreateL7Policy) SetRedirectTargetGroupIdNil() {
...
func (o *CreateL7Policy) SetRedirectPrefixNil() {
...
func (o *CreateL7Policy) SetRedirectUrlNil() {
...
func (o CreateL7Policy) MarshalJSON() ([]byte, error) {
...
func (o CreateL7Policy) ToMap() (map[string]interface{}, error) {
...
func (o *CreateL7Policy) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateL7Policy := _CreateL7Policy{}

	err = json.Unmarshal(data, &varCreateL7Policy)

	if err != nil {
		return err
	}

	*o = CreateL7Policy(varCreateL7Policy)
...
type NullableCreateL7Policy struct {
	value *CreateL7Policy
	isSet bool
}

func (v NullableCreateL7Policy) Get() *CreateL7Policy {
	return v.value
}

func (v *NullableCreateL7Policy) Set(val *CreateL7Policy) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateL7Policy) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateL7Policy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateL7Policy(val *CreateL7Policy) *NullableCreateL7Policy {
	return &NullableCreateL7Policy{value: val, isSet: true}
}

func (v NullableCreateL7Policy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateL7Policy) UnmarshalJSON(src []byte) error {
	v.isSet = true
