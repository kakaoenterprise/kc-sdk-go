...
// checks if the EditL7PolicyRuleModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditL7PolicyRuleModel{}

// EditL7PolicyRuleModel struct for EditL7PolicyRuleModel
type EditL7PolicyRuleModel struct {
...
type _EditL7PolicyRuleModel EditL7PolicyRuleModel
...
func (o *EditL7PolicyRuleModel) SetIsInvertedNil() {
...
func (o *EditL7PolicyRuleModel) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o EditL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
...
func (o EditL7PolicyRuleModel) ToMap() (map[string]interface{}, error) {
...
func (o *EditL7PolicyRuleModel) UnmarshalJSON(data []byte) (err error) {
	...
	varEditL7PolicyRuleModel := _EditL7PolicyRuleModel{}

	err = json.Unmarshal(data, &varEditL7PolicyRuleModel)

	if err != nil {
		return err
	}

	*o = EditL7PolicyRuleModel(varEditL7PolicyRuleModel)
...
type NullableEditL7PolicyRuleModel struct {
	value *EditL7PolicyRuleModel
	isSet bool
}

func (v NullableEditL7PolicyRuleModel) Get() *EditL7PolicyRuleModel {
	return v.value
}

func (v *NullableEditL7PolicyRuleModel) Set(val *EditL7PolicyRuleModel) {
	v.value = val
	v.isSet = true
}

func (v NullableEditL7PolicyRuleModel) IsSet() bool {
	return v.isSet
}

func (v *NullableEditL7PolicyRuleModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditL7PolicyRuleModel(val *EditL7PolicyRuleModel) *NullableEditL7PolicyRuleModel {
	return &NullableEditL7PolicyRuleModel{value: val, isSet: true}
}

func (v NullableEditL7PolicyRuleModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditL7PolicyRuleModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
