...
// checks if the FlavorModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlavorModel{}

// FlavorModel struct for FlavorModel
...
func (o *FlavorModel) SetDescriptionNil() {
...
func (o *FlavorModel) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o FlavorModel) MarshalJSON() ([]byte, error) {
...
func (o FlavorModel) ToMap() (map[string]interface{}, error) {
...
func (o *FlavorModel) UnmarshalJSON(data []byte) (err error) {
	...
	varFlavorModel := _FlavorModel{}

	err = json.Unmarshal(data, &varFlavorModel)

	if err != nil {
		return err
	}

	*o = FlavorModel(varFlavorModel)
...
type NullableFlavorModel struct {
	value *FlavorModel
	isSet bool
}

func (v NullableFlavorModel) Get() *FlavorModel {
	return v.value
}

func (v *NullableFlavorModel) Set(val *FlavorModel) {
	v.value = val
	v.isSet = true
}

func (v NullableFlavorModel) IsSet() bool {
	return v.isSet
}

func (v *NullableFlavorModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlavorModel(val *FlavorModel) *NullableFlavorModel {
	return &NullableFlavorModel{value: val, isSet: true}
}

func (v NullableFlavorModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlavorModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
