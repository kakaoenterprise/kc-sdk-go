...
// checks if the HealthMonitor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HealthMonitor{}

// HealthMonitor struct for HealthMonitor
...
type _HealthMonitor HealthMonitor
...
func (o *HealthMonitor) SetHttpMethodNil() {
...
func (o *HealthMonitor) SetUrlPathNil() {
	o.UrlPath.Set(nil)
}
...
func (o *HealthMonitor) SetExpectedCodesNil() {
...
func (o *HealthMonitor) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *HealthMonitor) SetHttpVersionNil() {
...
func (o HealthMonitor) MarshalJSON() ([]byte, error) {
...
func (o HealthMonitor) ToMap() (map[string]interface{}, error) {
...
func (o *HealthMonitor) UnmarshalJSON(data []byte) (err error) {
	...
	varHealthMonitor := _HealthMonitor{}

	err = json.Unmarshal(data, &varHealthMonitor)

	if err != nil {
		return err
	}

	*o = HealthMonitor(varHealthMonitor)
...
type NullableHealthMonitor struct {
	value *HealthMonitor
	isSet bool
}

func (v NullableHealthMonitor) Get() *HealthMonitor {
	return v.value
}

func (v *NullableHealthMonitor) Set(val *HealthMonitor) {
	v.value = val
	v.isSet = true
}

func (v NullableHealthMonitor) IsSet() bool {
	return v.isSet
}

func (v *NullableHealthMonitor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHealthMonitor(val *HealthMonitor) *NullableHealthMonitor {
	return &NullableHealthMonitor{value: val, isSet: true}
}

func (v NullableHealthMonitor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHealthMonitor) UnmarshalJSON(src []byte) error {
	v.isSet = true
