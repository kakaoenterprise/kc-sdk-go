...
const (
	LOADBALANCERPOOLPROTOCOL_HTTP  LoadBalancerPoolProtocol = "HTTP"
	LOADBALANCERPOOLPROTOCOL_HTTPS LoadBalancerPoolProtocol = "HTTPS"
	LOADBALANCERPOOLPROTOCOL_TCP   LoadBalancerPoolProtocol = "TCP"
	LOADBALANCERPOOLPROTOCOL_UDP   LoadBalancerPoolProtocol = "UDP"
	LOADBALANCERPOOLPROTOCOL_PROXY LoadBalancerPoolProtocol = "PROXY"
)
