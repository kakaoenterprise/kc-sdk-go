...
**InstanceGroupId** | **string** | 백업을 생성할 대상 MySQL 인스턴스 그룹 ID &lt;br/&gt;- [List MySQL instance groups](https://docs.kakaocloud.com/openapi/data-store/mysql/list-mysql-instance-groups)에서 확인 | 
