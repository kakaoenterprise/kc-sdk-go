...
> ExportMysqlInstanceLogs(ctx, instanceGroupId, instanceId).XAuthToken(xAuthToken).ExportMysqlInstanceLogsRequest(exportMysqlInstanceLogsRequest).Execute()
...
func main() {
	...
	r, err := apiClient.InstanceAPI.ExportMysqlInstanceLogs(context.Background(), instanceGroupId, instanceId).XAuthToken(xAuthToken).ExportMysqlInstanceLogsRequest(exportMysqlInstanceLogsRequest).Execute()
	if err != nil {
...
> ListMysqlInstanceTypesFlavorsResponse ListMysqlInstanceTypesFlavors(ctx).XAuthToken(xAuthToken).ShowAll(showAll).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InstanceAPI.ListMysqlInstanceTypesFlavors(context.Background()).XAuthToken(xAuthToken).ShowAll(showAll).Execute()
	if err != nil {
...
> ListMysqlInstancesResponse ListMysqlInstances(ctx, instanceGroupId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InstanceAPI.ListMysqlInstances(context.Background(), instanceGroupId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> RestartMysqlInstances(ctx, instanceGroupId).XAuthToken(xAuthToken).RestartMysqlInstancesRequest(restartMysqlInstancesRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.InstanceAPI.RestartMysqlInstances(context.Background(), instanceGroupId).XAuthToken(xAuthToken).RestartMysqlInstancesRequest(restartMysqlInstancesRequest).Execute()
	if err != nil {
