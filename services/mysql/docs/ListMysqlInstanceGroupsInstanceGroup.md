...
**NetworkInfo** | Pointer to [**NullableNetworkInfo**](NetworkInfo.md) |  | [optional] 
**SpecContent** | [**SpecContent**](SpecContent.md) | MySQL 인스턴스 그룹 구성 정보 | 
**Instances** | Pointer to [**NullableListMysqlInstanceGroupsTopology**](ListMysqlInstanceGroupsTopology.md) |  | [optional] 
...
**BackupSchedule** | Pointer to [**NullableBackupSchedule**](BackupSchedule.md) |  | [optional] 
