...
**EngineVersion** | **string** | [MySQL 엔진 버전](https://docs.kakaocloud.com/openapi/data-store/mysql/list-available-mysql-engine-versions) | 
**FlavorId** | **string** | [인스턴스에 적용할 Flavor ID](https://docs.kakaocloud.com/openapi/data-store/mysql/list-mysql-instance-types-flavors) | 
