...
// checks if the DataDetailParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataDetailParameters{}

// DataDetailParameters struct for DataDetailParameters
type DataDetailParameters struct {
	// 파라미터 이름
	Key string `json:"key"`
	// 파라미터 데이터 타입
...
type _DataDetailParameters DataDetailParameters
...
func (o *DataDetailParameters) SetDefaultParameterValueNil() {
...
func (o *DataDetailParameters) SetParameterTypeNil() {
...
func (o *DataDetailParameters) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *DataDetailParameters) SetValidationValueFormatNil() {
...
func (o DataDetailParameters) MarshalJSON() ([]byte, error) {
...
func (o DataDetailParameters) ToMap() (map[string]interface{}, error) {
...
func (o *DataDetailParameters) UnmarshalJSON(data []byte) (err error) {
	...
	varDataDetailParameters := _DataDetailParameters{}

	err = json.Unmarshal(data, &varDataDetailParameters)

	if err != nil {
		return err
	}

	*o = DataDetailParameters(varDataDetailParameters)
...
type NullableDataDetailParameters struct {
	value *DataDetailParameters
	isSet bool
}

func (v NullableDataDetailParameters) Get() *DataDetailParameters {
	return v.value
}

func (v *NullableDataDetailParameters) Set(val *DataDetailParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableDataDetailParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableDataDetailParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataDetailParameters(val *DataDetailParameters) *NullableDataDetailParameters {
	return &NullableDataDetailParameters{value: val, isSet: true}
}

func (v NullableDataDetailParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataDetailParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
