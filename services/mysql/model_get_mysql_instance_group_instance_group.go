...
// checks if the GetMysqlInstanceGroupInstanceGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMysqlInstanceGroupInstanceGroup{}

// GetMysqlInstanceGroupInstanceGroup struct for GetMysqlInstanceGroupInstanceGroup
type GetMysqlInstanceGroupInstanceGroup struct {
	// MySQL 인스턴스 그룹 ID
	Id string `json:"id"`
	...
	Instances   NullableGetMysqlInstanceGroupTopology `json:"instances,omitempty"`
...
type _GetMysqlInstanceGroupInstanceGroup GetMysqlInstanceGroupInstanceGroup
...
func NewGetMysqlInstanceGroupInstanceGroup(id string, createdAt string, updatedAt string, license string, name string, projectId string, isMultiAz bool, specContent SpecContent, status InstanceGroupStatus, parameterGroup ParameterGroup) *GetMysqlInstanceGroupInstanceGroup {
	this := GetMysqlInstanceGroupInstanceGroup{}
	this.Id = id
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetDescriptionNil() {
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetCreatorNil() {
	o.Creator.Set(nil)
}
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetSourceBackupIdNil() {
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetNetworkInfoNil() {
...
func (o *GetMysqlInstanceGroupInstanceGroup) GetInstances() GetMysqlInstanceGroupTopology {
	if o == nil || IsNil(o.Instances.Get()) {
		var ret GetMysqlInstanceGroupTopology
		return ret
	}
...
// SetInstances gets a reference to the given NullableGetMysqlInstanceGroupTopology and assigns it to the Instances field.
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetInstancesNil() {
	o.Instances.Set(nil)
}
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetExtraInfoNil() {
	o.ExtraInfo.Set(nil)
}
...
func (o *GetMysqlInstanceGroupInstanceGroup) SetBackupScheduleNil() {
...
func (o GetMysqlInstanceGroupInstanceGroup) MarshalJSON() ([]byte, error) {
...
func (o GetMysqlInstanceGroupInstanceGroup) ToMap() (map[string]interface{}, error) {
...
func (o *GetMysqlInstanceGroupInstanceGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMysqlInstanceGroupInstanceGroup := _GetMysqlInstanceGroupInstanceGroup{}

	err = json.Unmarshal(data, &varGetMysqlInstanceGroupInstanceGroup)

	if err != nil {
		return err
	}

	*o = GetMysqlInstanceGroupInstanceGroup(varGetMysqlInstanceGroupInstanceGroup)
...
type NullableGetMysqlInstanceGroupInstanceGroup struct {
	value *GetMysqlInstanceGroupInstanceGroup
	isSet bool
}

func (v NullableGetMysqlInstanceGroupInstanceGroup) Get() *GetMysqlInstanceGroupInstanceGroup {
	return v.value
}

func (v *NullableGetMysqlInstanceGroupInstanceGroup) Set(val *GetMysqlInstanceGroupInstanceGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMysqlInstanceGroupInstanceGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMysqlInstanceGroupInstanceGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMysqlInstanceGroupInstanceGroup(val *GetMysqlInstanceGroupInstanceGroup) *NullableGetMysqlInstanceGroupInstanceGroup {
	return &NullableGetMysqlInstanceGroupInstanceGroup{value: val, isSet: true}
}

func (v NullableGetMysqlInstanceGroupInstanceGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMysqlInstanceGroupInstanceGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
