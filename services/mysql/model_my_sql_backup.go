...
// checks if the MySQLBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MySQLBackup{}

// MySQLBackup struct for MySQLBackup
...
func (o *MySQLBackup) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *MySQLBackup) SetCreatorNameNil() {
...
func (o *MySQLBackup) SetDescriptionNil() {
...
func (o *MySQLBackup) SetDiskSizeNil() {
	o.DiskSize.Set(nil)
}
...
func (o *MySQLBackup) SetExpireAtNil() {
	o.ExpireAt.Set(nil)
}
...
func (o *MySQLBackup) SetExpiryDurationNil() {
...
func (o *MySQLBackup) SetExtraInfoNil() {
	o.ExtraInfo.Set(nil)
}
...
func (o *MySQLBackup) SetInstanceGroupIdNil() {
...
func (o *MySQLBackup) SetInstanceGroupNameNil() {
...
func (o *MySQLBackup) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *MySQLBackup) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *MySQLBackup) SetStartedAtNil() {
	o.StartedAt.Set(nil)
}
...
func (o *MySQLBackup) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *MySQLBackup) SetEngineVersionNil() {
...
func (o MySQLBackup) MarshalJSON() ([]byte, error) {
...
func (o MySQLBackup) ToMap() (map[string]interface{}, error) {
...
func (o *MySQLBackup) UnmarshalJSON(data []byte) (err error) {
	varMySQLBackup := _MySQLBackup{}

	err = json.Unmarshal(data, &varMySQLBackup)

	if err != nil {
		return err
	}

	*o = MySQLBackup(varMySQLBackup)
...
type NullableMySQLBackup struct {
	value *MySQLBackup
	isSet bool
}

func (v NullableMySQLBackup) Get() *MySQLBackup {
	return v.value
}

func (v *NullableMySQLBackup) Set(val *MySQLBackup) {
	v.value = val
	v.isSet = true
}

func (v NullableMySQLBackup) IsSet() bool {
	return v.isSet
}

func (v *NullableMySQLBackup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMySQLBackup(val *MySQLBackup) *NullableMySQLBackup {
	return &NullableMySQLBackup{value: val, isSet: true}
}

func (v NullableMySQLBackup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMySQLBackup) UnmarshalJSON(src []byte) error {
	v.isSet = true
