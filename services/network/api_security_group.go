...
type SecurityGroupAPI interface {
	...
	*/
	...
	/*
			...
			보안 그룹에 대한 새로운 보안 그룹 규칙(인바운드 또는 아웃바운드)을 생성하여 특정 트래픽을 허용하거나 제한합니다. 자세한 설명은 [보안 그룹 규칙](https://docs.kakaocloud.com/service/networking/vpc/main/vpc-security-group#security-group-rules)을 참고해 주세요.
