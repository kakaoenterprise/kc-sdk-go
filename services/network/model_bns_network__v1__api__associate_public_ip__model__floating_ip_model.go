...
// checks if the BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel{}

// BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel struct for BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel
type BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel struct {
	// 퍼블릭 IP의 고유 ID
	Id string `json:"id"`
	// 퍼블릭 IP의 현재 상태
...
type _BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel
...
func NewBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel(id string, status PublicIpStatus, description string, projectId string, publicIp string, createdAt time.Time, updatedAt time.Time) *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel {
	this := BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel{}
	this.Id = id
	this.Status = status
...
func (o *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) SetPrivateIpNil() {
	o.PrivateIp.Set(nil)
}
...
func (o BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) MarshalJSON() ([]byte, error) {
...
func (o BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel := _BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel{}

	err = json.Unmarshal(data, &varBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel)

	if err != nil {
		return err
	}

	*o = BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel(varBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel)
...
type NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel struct {
	value *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel
	isSet bool
}

func (v NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) Get() *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel {
	return v.value
}

func (v *NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) Set(val *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel(val *BnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) *NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel {
	return &NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel{value: val, isSet: true}
}

func (v NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsNetworkV1ApiAssociatePublicIpModelFloatingIpModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
