...
type _CreateSecurityGroupResponse CreateSecurityGroupResponse
...
func (o *CreateSecurityGroupResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSecurityGroupResponse := _CreateSecurityGroupResponse{}

	err = json.Unmarshal(data, &varCreateSecurityGroupResponse)

	if err != nil {
		return err
	}

	*o = CreateSecurityGroupResponse(varCreateSecurityGroupResponse)
