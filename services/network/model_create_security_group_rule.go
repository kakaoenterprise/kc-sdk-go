...
// checks if the CreateSecurityGroupRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSecurityGroupRule{}

// CreateSecurityGroupRule struct for CreateSecurityGroupRule
...
type _CreateSecurityGroupRule CreateSecurityGroupRule
...
func (o *CreateSecurityGroupRule) SetDescriptionNil() {
...
func (o *CreateSecurityGroupRule) SetRemoteIpPrefixNil() {
...
func (o *CreateSecurityGroupRule) SetRemoteGroupIdNil() {
...
func (o *CreateSecurityGroupRule) SetPortRangeMinNil() {
...
func (o *CreateSecurityGroupRule) SetPortRangeMaxNil() {
...
func (o CreateSecurityGroupRule) MarshalJSON() ([]byte, error) {
...
func (o CreateSecurityGroupRule) ToMap() (map[string]interface{}, error) {
...
func (o *CreateSecurityGroupRule) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSecurityGroupRule := _CreateSecurityGroupRule{}

	err = json.Unmarshal(data, &varCreateSecurityGroupRule)

	if err != nil {
		return err
	}

	*o = CreateSecurityGroupRule(varCreateSecurityGroupRule)
...
type NullableCreateSecurityGroupRule struct {
	value *CreateSecurityGroupRule
	isSet bool
}

func (v NullableCreateSecurityGroupRule) Get() *CreateSecurityGroupRule {
	return v.value
}

func (v *NullableCreateSecurityGroupRule) Set(val *CreateSecurityGroupRule) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSecurityGroupRule) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSecurityGroupRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSecurityGroupRule(val *CreateSecurityGroupRule) *NullableCreateSecurityGroupRule {
	return &NullableCreateSecurityGroupRule{value: val, isSet: true}
}

func (v NullableCreateSecurityGroupRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSecurityGroupRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
