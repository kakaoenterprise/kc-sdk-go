...
------------ | ------------- | ------------- | -------------
**Ids** | **[]string** | 접근 제어 대상의 고유 ID 목록 &lt;br/&gt;- [List secrets access targets](https://docs.kakaocloud.com/openapi/security/secrets-manager/list-secrets-access-targets)에서 확인 | 
