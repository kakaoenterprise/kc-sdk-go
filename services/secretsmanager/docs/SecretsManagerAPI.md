...
> ActivateSecretsManagerServiceResponse ActivateSecretsManagerService(ctx).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	resp, r, err := apiClient.SecretsManagerAPI.ActivateSecretsManagerService(context.Background()).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> GetSecretsManagerServiceStatusResponse GetSecretsManagerServiceStatus(ctx).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SecretsManagerAPI.GetSecretsManagerServiceStatus(context.Background()).XAuthToken(xAuthToken).Execute()
	if err != nil {
