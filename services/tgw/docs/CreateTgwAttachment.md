...
**VpcId** | **string** | 연결할 VPC ID &lt;br/&gt;- [List VPCs](https://docs.kakaocloud.com/openapi/networking/vpc/list-vpcs)에서 확인 | 
**SubnetIds** | **[]string** | 연결할 서브넷 ID 목록 &lt;br/&gt;- [List subnets](https://docs.kakaocloud.com/openapi/networking/vpc/list-subnets)에서 확인 | 
