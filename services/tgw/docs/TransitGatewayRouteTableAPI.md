...
> CreateTgwRouteResponse CreateTgwRoute(ctx, routeTableId).XAuthToken(xAuthToken).CreateTgwRouteRequest(createTgwRouteRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.CreateTgwRoute(context.Background(), routeTableId).XAuthToken(xAuthToken).CreateTgwRouteRequest(createTgwRouteRequest).Execute()
	if err != nil {
...
> CreateTgwRouteTableResponse CreateTgwRouteTable(ctx).XAuthToken(xAuthToken).CreateTgwRouteTableRequest(createTgwRouteTableRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.CreateTgwRouteTable(context.Background()).XAuthToken(xAuthToken).CreateTgwRouteTableRequest(createTgwRouteTableRequest).Execute()
	if err != nil {
...
> CreateTgwRouteTableAssociationResponse CreateTgwRouteTableAssociation(ctx, routeTableId).XAuthToken(xAuthToken).CreateTgwRouteTableAssociationRequest(createTgwRouteTableAssociationRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.CreateTgwRouteTableAssociation(context.Background(), routeTableId).XAuthToken(xAuthToken).CreateTgwRouteTableAssociationRequest(createTgwRouteTableAssociationRequest).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.TransitGatewayRouteTableAPI.DeleteTgwRoute(context.Background(), routeTableId, routeId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.TransitGatewayRouteTableAPI.DeleteTgwRouteTable(context.Background(), routeTableId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.TransitGatewayRouteTableAPI.DeleteTgwRouteTableAssociation(context.Background(), routeTableId, associationId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
> GetTgwRouteTableResponse GetTgwRouteTable(ctx, routeTableId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.GetTgwRouteTable(context.Background(), routeTableId).XAuthToken(xAuthToken).Execute()
	if err != nil {
...
func main() {
	routeTableId := "routeTableId_example" // string | 조회할 Transit Gateway 라우팅 테이블 ID <br/>- [List TGW route tables](https://docs.kakaocloud.com/openapi/networking/tgw/list-tgw-route-tables)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.ListTgwRouteTableAssociations(context.Background(), routeTableId).XAuthToken(xAuthToken).ResourceName(resourceName).ResourceId(resourceId).ResourceProvisioningStatus(resourceProvisioningStatus).ResourceType(resourceType).ProvisioningStatus(provisioningStatus).ResourceAttachmentId(resourceAttachmentId).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**routeTableId** | **string** | 조회할 Transit Gateway 라우팅 테이블 ID &lt;br/&gt;- [List TGW route tables](https://docs.kakaocloud.com/openapi/networking/tgw/list-tgw-route-tables)에서 확인 | 
...
> ListTgwRouteTablesResponse ListTgwRouteTables(ctx).XAuthToken(xAuthToken).Id(id).Name(name).TgwId(tgwId).TgwName(tgwName).ProvisioningStatus(provisioningStatus).CreatedAt(createdAt).UpdatedAt(updatedAt).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.ListTgwRouteTables(context.Background()).XAuthToken(xAuthToken).Id(id).Name(name).TgwId(tgwId).TgwName(tgwName).ProvisioningStatus(provisioningStatus).CreatedAt(createdAt).UpdatedAt(updatedAt).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.ListTgwRoutes(context.Background(), routeTableId).XAuthToken(xAuthToken).DestinationCidrBlock(destinationCidrBlock).RouteType(routeType).ProvisioningStatus(provisioningStatus).ResourceType(resourceType).ResourceId(resourceId).ResourceName(resourceName).ResourceProvisioningStatus(resourceProvisioningStatus).ResourceAttachmentId(resourceAttachmentId).Offset(offset).Limit(limit).SortKeys(sortKeys).SortDirs(sortDirs).Execute()
	if err != nil {
...
> UpdateTgwRouteResponse UpdateTgwRoute(ctx, routeTableId, routeId).XAuthToken(xAuthToken).UpdateTgwRouteRequest(updateTgwRouteRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.UpdateTgwRoute(context.Background(), routeTableId, routeId).XAuthToken(xAuthToken).UpdateTgwRouteRequest(updateTgwRouteRequest).Execute()
	if err != nil {
...
> UpdateTgwRouteTableResponse UpdateTgwRouteTable(ctx, routeTableId).XAuthToken(xAuthToken).UpdateTgwRouteTableRequest(updateTgwRouteTableRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransitGatewayRouteTableAPI.UpdateTgwRouteTable(context.Background(), routeTableId).XAuthToken(xAuthToken).UpdateTgwRouteTableRequest(updateTgwRouteTableRequest).Execute()
	if err != nil {
