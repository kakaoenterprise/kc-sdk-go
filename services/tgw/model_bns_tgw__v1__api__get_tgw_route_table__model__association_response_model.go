...
// checks if the BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel{}

// BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel struct for BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel
type BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel struct {
...
type _BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel
...
func NewBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel(resource BnsTgwV1ApiGetTgwRouteTableModelResourceResponseModel) *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel {
	this := BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel{}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetResourceAttachmentIdNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetResourceIdNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetResourceTypeNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetTgwAttachmentIdNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetTgwRouteTableIdNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) SetProvisioningStatusNil() {
...
func (o BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) MarshalJSON() ([]byte, error) {
...
func (o BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel := _BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel{}

	err = json.Unmarshal(data, &varBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel)

	if err != nil {
		return err
	}

	*o = BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel(varBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel)
...
type NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel struct {
	value *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel
	isSet bool
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) Get() *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel {
	return v.value
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) Set(val *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel(val *BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) *NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel {
	return &NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel{value: val, isSet: true}
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
