...
// checks if the BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel{}

// BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel struct for BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel
type BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel struct {
	...
	Routes []BnsTgwV1ApiGetTgwRouteTableModelRouteResponseModel `json:"routes,omitempty"`
	Associations []BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel `json:"associations,omitempty"`
	CreatedAt NullableTime `json:"created_at,omitempty"`
	UpdatedAt NullableTime `json:"updated_at,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel
...
func NewBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel() *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel {
	this := BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel{}
	return &this
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetProjectNameNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetTgwIdNil() {
	o.TgwId.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetTgwNameNil() {
	o.TgwName.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetIsDefaultAssociationRouteTableNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetIsDefaultPropagationRouteTableNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetProvisioningStatusNil() {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) GetRoutes() []BnsTgwV1ApiGetTgwRouteTableModelRouteResponseModel {
	if o == nil {
		var ret []BnsTgwV1ApiGetTgwRouteTableModelRouteResponseModel
		return ret
	}
	return o.Routes
}
...
// SetRoutes gets a reference to the given []BnsTgwV1ApiGetTgwRouteTableModelRouteResponseModel and assigns it to the Routes field.
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) GetAssociations() []BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel {
	if o == nil {
		var ret []BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel
		return ret
	}
...
// SetAssociations gets a reference to the given []BnsTgwV1ApiGetTgwRouteTableModelAssociationResponseModel and assigns it to the Associations field.
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) MarshalJSON() ([]byte, error) {
...
func (o BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) UnmarshalJSON(data []byte) (err error) {
	varBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel := _BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel{}

	err = json.Unmarshal(data, &varBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel)

	if err != nil {
		return err
	}

	*o = BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel(varBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel)
...
type NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel struct {
	value *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel
	isSet bool
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) Get() *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel {
	return v.value
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) Set(val *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel(val *BnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) *NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel {
	return &NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel{value: val, isSet: true}
}

func (v NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsTgwV1ApiGetTgwRouteTableModelTgwRouteTableResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
