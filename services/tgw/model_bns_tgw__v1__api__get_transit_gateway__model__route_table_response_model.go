...
// checks if the BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel{}

// BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel struct for BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel
type BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel struct {
...
type _BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel
...
func NewBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel() *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel {
	this := BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel{}
	return &this
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetTgwIdNil() {
	o.TgwId.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetIsDefaultAssociationRouteTableNil() {
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetIsDefaultPropagationRouteTableNil() {
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetProvisioningStatusNil() {
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) MarshalJSON() ([]byte, error) {
...
func (o BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) UnmarshalJSON(data []byte) (err error) {
	varBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel := _BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel{}

	err = json.Unmarshal(data, &varBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel)

	if err != nil {
		return err
	}

	*o = BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel(varBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel)
...
type NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel struct {
	value *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel
	isSet bool
}

func (v NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) Get() *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel {
	return v.value
}

func (v *NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) Set(val *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel(val *BnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) *NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel {
	return &NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel{value: val, isSet: true}
}

func (v NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsTgwV1ApiGetTransitGatewayModelRouteTableResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
