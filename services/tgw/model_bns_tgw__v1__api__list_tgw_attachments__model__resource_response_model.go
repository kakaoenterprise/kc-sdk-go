...
// checks if the BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel{}

// BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel struct for BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel
type BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel struct {
...
type _BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel
...
func NewBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel() *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel {
	this := BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel{}
	return &this
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetDescriptionNil() {
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetAvailabilityZoneNil() {
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetCidrBlockNil() {
	o.CidrBlock.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetOperatingStatusNil() {
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetProvisioningStatusNil() {
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetVpcIdNil() {
	o.VpcId.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) MarshalJSON() ([]byte, error) {
...
func (o BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) UnmarshalJSON(data []byte) (err error) {
	varBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel := _BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel{}

	err = json.Unmarshal(data, &varBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel)

	if err != nil {
		return err
	}

	*o = BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel(varBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel)
...
type NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel struct {
	value *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel
	isSet bool
}

func (v NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) Get() *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel {
	return v.value
}

func (v *NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) Set(val *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel(val *BnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) *NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel {
	return &NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel{value: val, isSet: true}
}

func (v NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsTgwV1ApiListTgwAttachmentsModelResourceResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
