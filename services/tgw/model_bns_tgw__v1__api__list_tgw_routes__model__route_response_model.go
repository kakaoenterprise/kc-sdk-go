...
// checks if the BnsTgwV1ApiListTgwRoutesModelRouteResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsTgwV1ApiListTgwRoutesModelRouteResponseModel{}

// BnsTgwV1ApiListTgwRoutesModelRouteResponseModel struct for BnsTgwV1ApiListTgwRoutesModelRouteResponseModel
type BnsTgwV1ApiListTgwRoutesModelRouteResponseModel struct {
	...
	// 연결된 리소스의 요약 정보 객체
	Resource BnsTgwV1ApiListTgwRoutesModelResourceResponseModel `json:"resource"`
	AdditionalProperties map[string]interface{}
}

type _BnsTgwV1ApiListTgwRoutesModelRouteResponseModel BnsTgwV1ApiListTgwRoutesModelRouteResponseModel
...
func NewBnsTgwV1ApiListTgwRoutesModelRouteResponseModel(resource BnsTgwV1ApiListTgwRoutesModelResourceResponseModel) *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel {
	this := BnsTgwV1ApiListTgwRoutesModelRouteResponseModel{}
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetRouteTypeNil() {
	o.RouteType.Set(nil)
}
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetDestinationCidrBlockNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetResourceAttachmentIdNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetResourceIdNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetResourceTypeNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetTgwAttachmentIdNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetTgwRouteTableIdNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) SetProvisioningStatusNil() {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) GetResource() BnsTgwV1ApiListTgwRoutesModelResourceResponseModel {
	if o == nil {
		var ret BnsTgwV1ApiListTgwRoutesModelResourceResponseModel
		return ret
	}
...
func (o BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) MarshalJSON() ([]byte, error) {
...
func (o BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsTgwV1ApiListTgwRoutesModelRouteResponseModel := _BnsTgwV1ApiListTgwRoutesModelRouteResponseModel{}

	err = json.Unmarshal(data, &varBnsTgwV1ApiListTgwRoutesModelRouteResponseModel)

	if err != nil {
		return err
	}

	*o = BnsTgwV1ApiListTgwRoutesModelRouteResponseModel(varBnsTgwV1ApiListTgwRoutesModelRouteResponseModel)
...
type NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel struct {
	value *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel
	isSet bool
}

func (v NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) Get() *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel {
	return v.value
}

func (v *NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) Set(val *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel(val *BnsTgwV1ApiListTgwRoutesModelRouteResponseModel) *NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel {
	return &NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel{value: val, isSet: true}
}

func (v NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsTgwV1ApiListTgwRoutesModelRouteResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
