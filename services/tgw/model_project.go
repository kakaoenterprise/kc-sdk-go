...
type Project struct {
	...
	DisabledAt           NullableString `json:"disabled_at,omitempty"`
...
func (o *Project) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
// SetDisabledAt gets a reference to the given NullableString and assigns it to the DisabledAt field.
func (o *Project) SetDisabledAt(v string) {
	o.DisabledAt.Set(&v)
}

// SetDisabledAtNil sets the value for DisabledAt to be an explicit nil
func (o *Project) SetDisabledAtNil() {
