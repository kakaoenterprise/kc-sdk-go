...
// checks if the TgwRouteTable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TgwRouteTable{}

// TgwRouteTable struct for TgwRouteTable
...
type _TgwRouteTable TgwRouteTable
...
func (o *TgwRouteTable) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *TgwRouteTable) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *TgwRouteTable) SetProjectNameNil() {
...
func (o *TgwRouteTable) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *TgwRouteTable) SetTgwIdNil() {
	o.TgwId.Set(nil)
}
...
func (o *TgwRouteTable) SetTgwNameNil() {
	o.TgwName.Set(nil)
}
...
func (o *TgwRouteTable) SetIsDefaultAssociationRouteTableNil() {
...
func (o *TgwRouteTable) SetIsDefaultPropagationRouteTableNil() {
...
func (o *TgwRouteTable) SetProvisioningStatusNil() {
...
func (o *TgwRouteTable) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *TgwRouteTable) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o TgwRouteTable) MarshalJSON() ([]byte, error) {
...
func (o TgwRouteTable) ToMap() (map[string]interface{}, error) {
...
func (o *TgwRouteTable) UnmarshalJSON(data []byte) (err error) {
	varTgwRouteTable := _TgwRouteTable{}

	err = json.Unmarshal(data, &varTgwRouteTable)

	if err != nil {
		return err
	}

	*o = TgwRouteTable(varTgwRouteTable)
...
type NullableTgwRouteTable struct {
	value *TgwRouteTable
	isSet bool
}

func (v NullableTgwRouteTable) Get() *TgwRouteTable {
	return v.value
}

func (v *NullableTgwRouteTable) Set(val *TgwRouteTable) {
	v.value = val
	v.isSet = true
}

func (v NullableTgwRouteTable) IsSet() bool {
	return v.isSet
}

func (v *NullableTgwRouteTable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTgwRouteTable(val *TgwRouteTable) *NullableTgwRouteTable {
	return &NullableTgwRouteTable{value: val, isSet: true}
}

func (v NullableTgwRouteTable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTgwRouteTable) UnmarshalJSON(src []byte) error {
	v.isSet = true
