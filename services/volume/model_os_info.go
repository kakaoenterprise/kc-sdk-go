...
// checks if the OsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsInfo{}
...
func (o *OsInfo) SetArchitectureNil() {
...
func (o OsInfo) ToMap() (map[string]interface{}, error) {
...
func (o *OsInfo) UnmarshalJSON(data []byte) (err error) {
	varOsInfo := _OsInfo{}

	err = json.Unmarshal(data, &varOsInfo)
...
type NullableOsInfo struct {
	value *OsInfo
	isSet bool
}

func (v NullableOsInfo) Get() *OsInfo {
	return v.value
}

func (v *NullableOsInfo) Set(val *OsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOsInfo(val *OsInfo) *NullableOsInfo {
	return &NullableOsInfo{value: val, isSet: true}
}

func (v NullableOsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
