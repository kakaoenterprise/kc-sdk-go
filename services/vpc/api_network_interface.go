...
type NetworkInterfaceAPI interface {
	...
	*/
	...
	CreateNetworkInterfaceExecute(r ApiCreateNetworkInterfaceRequest) (*CreateNetworkInterfaceResponse, *http.Response, error)
	...
	/*
		...
		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param networkInterfaceId 삭제할 네트워크 인터페이스 ID <br/>- [List network interfaces](/openapi/networking/vpc/list-network-interfaces)에서 확인
	...
	*/
	...
	GetNetworkInterfaceExecute(r ApiGetNetworkInterfaceRequest) (*GetNetworkInterfaceResponse, *http.Response, error)

	/*
		ListNetworkInterfaces List network interfaces

		프로젝트 내 네트워크 인터페이스 목록을 조회합니다. 필터 조건을 설정하여 특정 조건에 맞는 인터페이스만 조회할 수 있으며, 정렬 및 페이지네이션도 지원합니다.
	...
	*/
	...
	ListNetworkInterfacesExecute(r ApiListNetworkInterfacesRequest) (*ListNetworkInterfacesResponse, *http.Response, error)
	...
	:::caution 주의
	보안 그룹 변경은 연결된 인스턴스의 트래픽 흐름에 영향을 줄 수 있으므로, 변경 전 보안 그룹 구성을 확인해 주세요.
	:::

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param networkInterfaceId 수정할 네트워크 인터페이스 ID <br/>- [List network interfaces](/openapi/networking/vpc/list-network-interfaces)에서 확인
	...
	*/
	...
	//  @return UpdateNetworkInterfaceResponse
	UpdateNetworkInterfaceExecute(r ApiUpdateNetworkInterfaceRequest) (*UpdateNetworkInterfaceResponse, *http.Response, error)
	...
	`allowed_address_pairs`를 설정하면, 해당 IP 및 MAC 주소로 송신되는 패킷이 허용됩니다. 주로 L2 보안이 필요한 네트워크 환경에서 사용됩니다.
		...
		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param networkInterfaceId 설정할 대상 네트워크 인터페이스 ID <br/>- [List network interfaces](/openapi/networking/vpc/list-network-interfaces)에서 확인
...
func (r ApiCreateNetworkInterfaceRequest) CreateNetworkInterfaceRequest(createNetworkInterfaceRequest CreateNetworkInterfaceRequest) ApiCreateNetworkInterfaceRequest {
	r.createNetworkInterfaceRequest = &createNetworkInterfaceRequest
	return r
}

func (r ApiCreateNetworkInterfaceRequest) Execute() (*CreateNetworkInterfaceResponse, *http.Response, error) {
...
//
//	@return CreateNetworkInterfaceResponse
func (a *NetworkInterfaceAPIService) CreateNetworkInterfaceExecute(r ApiCreateNetworkInterfaceRequest) (*CreateNetworkInterfaceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CreateNetworkInterfaceResponse
	)
	...
	if r.createNetworkInterfaceRequest == nil {
		return localVarReturnValue, nil, reportError("createNetworkInterfaceRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createNetworkInterfaceRequest
	if r.ctx != nil {
...
func (r ApiGetNetworkInterfaceRequest) Execute() (*GetNetworkInterfaceResponse, *http.Response, error) {
...
//
//	@return GetNetworkInterfaceResponse
func (a *NetworkInterfaceAPIService) GetNetworkInterfaceExecute(r ApiGetNetworkInterfaceRequest) (*GetNetworkInterfaceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetNetworkInterfaceResponse
	)
...
func (r ApiListNetworkInterfacesRequest) Execute() (*ListNetworkInterfacesResponse, *http.Response, error) {
...
//
//	@return ListNetworkInterfacesResponse
func (a *NetworkInterfaceAPIService) ListNetworkInterfacesExecute(r ApiListNetworkInterfacesRequest) (*ListNetworkInterfacesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListNetworkInterfacesResponse
	)
...
type ApiUpdateNetworkInterfaceRequest struct {
	...
	networkInterfaceId            string
	xAuthToken                    *string
	updateNetworkInterfaceRequest *UpdateNetworkInterfaceRequest
}
...
func (r ApiUpdateNetworkInterfaceRequest) UpdateNetworkInterfaceRequest(updateNetworkInterfaceRequest UpdateNetworkInterfaceRequest) ApiUpdateNetworkInterfaceRequest {
	r.updateNetworkInterfaceRequest = &updateNetworkInterfaceRequest
	return r
}

func (r ApiUpdateNetworkInterfaceRequest) Execute() (*UpdateNetworkInterfaceResponse, *http.Response, error) {
...
//
//	@return UpdateNetworkInterfaceResponse
func (a *NetworkInterfaceAPIService) UpdateNetworkInterfaceExecute(r ApiUpdateNetworkInterfaceRequest) (*UpdateNetworkInterfaceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateNetworkInterfaceResponse
	)
	...
	if r.updateNetworkInterfaceRequest == nil {
		return localVarReturnValue, nil, reportError("updateNetworkInterfaceRequest is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "x-auth-token", r.xAuthToken, "simple", "")
	// body params
	localVarPostBody = r.updateNetworkInterfaceRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["x-auth-token"]; ok {
...
//
//	@return UpdateNetworkInterfaceAllowedAddressesResponse
func (a *NetworkInterfaceAPIService) UpdateNetworkInterfaceAllowedAddressesExecute(r ApiUpdateNetworkInterfaceAllowedAddressesRequest) (*UpdateNetworkInterfaceAllowedAddressesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
