...
> CreateNetworkInterfaceResponse CreateNetworkInterface(ctx).XAuthToken(xAuthToken).CreateNetworkInterfaceRequest(createNetworkInterfaceRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.NetworkInterfaceAPI.CreateNetworkInterface(context.Background()).XAuthToken(xAuthToken).CreateNetworkInterfaceRequest(createNetworkInterfaceRequest).Execute()
	if err != nil {
...
func main() {
	networkInterfaceId := "networkInterfaceId_example" // string | 삭제할 네트워크 인터페이스 ID <br/>- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
...
**networkInterfaceId** | **string** | 삭제할 네트워크 인터페이스 ID &lt;br/&gt;- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인 | 
...
> GetNetworkInterfaceResponse GetNetworkInterface(ctx, networkInterfaceId).XAuthToken(xAuthToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NetworkInterfaceAPI.ListNetworkInterfaces(context.Background()).XAuthToken(xAuthToken).Id(id).Name(name).Status(status).PrivateIp(privateIp).PublicIp(publicIp).DeviceOwner(deviceOwner).DeviceId(deviceId).SubnetId(subnetId).MacAddress(macAddress).SecurityGroupId(securityGroupId).SecurityGroupName(securityGroupName).CreatedAt(createdAt).UpdatedAt(updatedAt).SortKeys(sortKeys).SortDirs(sortDirs).Offset(offset).Limit(limit).Execute()
	if err != nil {
...
> UpdateNetworkInterfaceResponse UpdateNetworkInterface(ctx, networkInterfaceId).XAuthToken(xAuthToken).UpdateNetworkInterfaceRequest(updateNetworkInterfaceRequest).Execute()
...
func main() {
	networkInterfaceId := "networkInterfaceId_example" // string | 수정할 네트워크 인터페이스 ID <br/>- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NetworkInterfaceAPI.UpdateNetworkInterface(context.Background(), networkInterfaceId).XAuthToken(xAuthToken).UpdateNetworkInterfaceRequest(updateNetworkInterfaceRequest).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**networkInterfaceId** | **string** | 수정할 네트워크 인터페이스 ID &lt;br/&gt;- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인 | 
...
> UpdateNetworkInterfaceAllowedAddressesResponse UpdateNetworkInterfaceAllowedAddresses(ctx, networkInterfaceId).XAuthToken(xAuthToken).UpdateNetworkInterfaceAllowedAddressesRequest(updateNetworkInterfaceAllowedAddressesRequest).Execute()
...
func main() {
	networkInterfaceId := "networkInterfaceId_example" // string | 설정할 대상 네트워크 인터페이스 ID <br/>- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인
	xAuthToken := "xAuthToken_example" // string | - [API 인증 토큰](https://docs.kakaocloud.com/openapi/start#api-인증-토큰-발급)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NetworkInterfaceAPI.UpdateNetworkInterfaceAllowedAddresses(context.Background(), networkInterfaceId).XAuthToken(xAuthToken).UpdateNetworkInterfaceAllowedAddressesRequest(updateNetworkInterfaceAllowedAddressesRequest).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**networkInterfaceId** | **string** | 설정할 대상 네트워크 인터페이스 ID &lt;br/&gt;- [List network interfaces](https://docs.kakaocloud.com/openapi/networking/vpc/list-network-interfaces)에서 확인 | 
