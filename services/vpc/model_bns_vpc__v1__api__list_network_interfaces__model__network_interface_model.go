...
// checks if the BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel{}

// BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel struct for BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel
type BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel struct {
	// 네트워크 인터페이스 ID
	Id                                string                                                         `json:"id"`
	...
	AllowedAddressPairs               []BnsVpcV1ApiListNetworkInterfacesModelAllowedAddressPairModel `json:"allowed_address_pairs,omitempty"`
...
type _BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel
...
func NewBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel(id string) *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel {
	this := BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel{}
	this.Id = id
	return &this
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetDescriptionNil() {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetVpcIdNil() {
	o.VpcId.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetSubnetIdNil() {
	o.SubnetId.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetMacAddressNil() {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetDeviceIdNil() {
	o.DeviceId.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetDeviceOwnerNil() {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetProjectNameNil() {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetPublicIpNil() {
	o.PublicIp.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetPrivateIpNil() {
	o.PrivateIp.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetIsNetworkInterfaceSecurityEnabledNil() {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) GetAllowedAddressPairs() []BnsVpcV1ApiListNetworkInterfacesModelAllowedAddressPairModel {
	if o == nil {
		var ret []BnsVpcV1ApiListNetworkInterfacesModelAllowedAddressPairModel
		return ret
	}
...
// SetAllowedAddressPairs gets a reference to the given []BnsVpcV1ApiListNetworkInterfacesModelAllowedAddressPairModel and assigns it to the AllowedAddressPairs field.
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) MarshalJSON() ([]byte, error) {
...
func (o BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel := _BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel{}

	err = json.Unmarshal(data, &varBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel)

	if err != nil {
		return err
	}

	*o = BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel(varBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel)
...
type NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel struct {
	value *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel
	isSet bool
}

func (v NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) Get() *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel {
	return v.value
}

func (v *NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) Set(val *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel(val *BnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) *NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel {
	return &NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel{value: val, isSet: true}
}

func (v NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsVpcV1ApiListNetworkInterfacesModelNetworkInterfaceModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
