...
// checks if the BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel{}

// BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel struct for BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel
type BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel struct {
	// 네트워크 인터페이스 ID
	Id   string         `json:"id"`
...
type _BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel
...
func NewBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel(id string, status NetworkInterfaceStatus) *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel {
	this := BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel{}
	this.Id = id
	this.Status = status
	return &this
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetDescriptionNil() {
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetProjectIdNil() {
	o.ProjectId.Set(nil)
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetIsNetworkInterfaceSecurityEnabledNil() {
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetMacAddressNil() {
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetDeviceIdNil() {
	o.DeviceId.Set(nil)
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetPrivateIpNil() {
	o.PrivateIp.Set(nil)
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) MarshalJSON() ([]byte, error) {
...
func (o BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel := _BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel{}

	err = json.Unmarshal(data, &varBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel)

	if err != nil {
		return err
	}

	*o = BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel(varBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel)
...
type NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel struct {
	value *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel
	isSet bool
}

func (v NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) Get() *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel {
	return v.value
}

func (v *NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) Set(val *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel(val *BnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) *NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel {
	return &NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel{value: val, isSet: true}
}

func (v NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsVpcV1ApiUpdateNetworkInterfaceAllowedAddressesModelNetworkInterfaceModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
