...
// checks if the BnsVpcV1ApiUpdateRouteModelRouteModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsVpcV1ApiUpdateRouteModelRouteModel{}

// BnsVpcV1ApiUpdateRouteModelRouteModel struct for BnsVpcV1ApiUpdateRouteModelRouteModel
type BnsVpcV1ApiUpdateRouteModelRouteModel struct {
	// 라우팅의 고유 ID
	Id string `json:"id"`
	// 프로비저닝 상태
...
type _BnsVpcV1ApiUpdateRouteModelRouteModel BnsVpcV1ApiUpdateRouteModelRouteModel
...
func NewBnsVpcV1ApiUpdateRouteModelRouteModel(id string, provisioningStatus ProvisioningStatus, destination string, isLocalRoute bool) *BnsVpcV1ApiUpdateRouteModelRouteModel {
	this := BnsVpcV1ApiUpdateRouteModelRouteModel{}
	this.Id = id
...
func (o BnsVpcV1ApiUpdateRouteModelRouteModel) MarshalJSON() ([]byte, error) {
...
func (o BnsVpcV1ApiUpdateRouteModelRouteModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsVpcV1ApiUpdateRouteModelRouteModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsVpcV1ApiUpdateRouteModelRouteModel := _BnsVpcV1ApiUpdateRouteModelRouteModel{}

	err = json.Unmarshal(data, &varBnsVpcV1ApiUpdateRouteModelRouteModel)

	if err != nil {
		return err
	}

	*o = BnsVpcV1ApiUpdateRouteModelRouteModel(varBnsVpcV1ApiUpdateRouteModelRouteModel)
...
type NullableBnsVpcV1ApiUpdateRouteModelRouteModel struct {
	value *BnsVpcV1ApiUpdateRouteModelRouteModel
	isSet bool
}

func (v NullableBnsVpcV1ApiUpdateRouteModelRouteModel) Get() *BnsVpcV1ApiUpdateRouteModelRouteModel {
	return v.value
}

func (v *NullableBnsVpcV1ApiUpdateRouteModelRouteModel) Set(val *BnsVpcV1ApiUpdateRouteModelRouteModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsVpcV1ApiUpdateRouteModelRouteModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsVpcV1ApiUpdateRouteModelRouteModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsVpcV1ApiUpdateRouteModelRouteModel(val *BnsVpcV1ApiUpdateRouteModelRouteModel) *NullableBnsVpcV1ApiUpdateRouteModelRouteModel {
	return &NullableBnsVpcV1ApiUpdateRouteModelRouteModel{value: val, isSet: true}
}

func (v NullableBnsVpcV1ApiUpdateRouteModelRouteModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsVpcV1ApiUpdateRouteModelRouteModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
