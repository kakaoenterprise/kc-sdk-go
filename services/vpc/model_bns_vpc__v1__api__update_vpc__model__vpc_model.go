...
// checks if the BnsVpcV1ApiUpdateVpcModelVpcModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BnsVpcV1ApiUpdateVpcModelVpcModel{}

// BnsVpcV1ApiUpdateVpcModelVpcModel struct for BnsVpcV1ApiUpdateVpcModelVpcModel
type BnsVpcV1ApiUpdateVpcModelVpcModel struct {
	// VPC의 고유 ID
	Id string `json:"id"`
	// VPC가 속한 프로젝트의 ID
...
type _BnsVpcV1ApiUpdateVpcModelVpcModel BnsVpcV1ApiUpdateVpcModelVpcModel
...
func NewBnsVpcV1ApiUpdateVpcModelVpcModel(id string, projectId string, name string, isDefault bool, region Region, cidrBlock string, provisioningStatus ProvisioningStatus, createdAt time.Time, updatedAt time.Time, description string) *BnsVpcV1ApiUpdateVpcModelVpcModel {
	this := BnsVpcV1ApiUpdateVpcModelVpcModel{}
	this.Id = id
...
func (o BnsVpcV1ApiUpdateVpcModelVpcModel) MarshalJSON() ([]byte, error) {
...
func (o BnsVpcV1ApiUpdateVpcModelVpcModel) ToMap() (map[string]interface{}, error) {
...
func (o *BnsVpcV1ApiUpdateVpcModelVpcModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBnsVpcV1ApiUpdateVpcModelVpcModel := _BnsVpcV1ApiUpdateVpcModelVpcModel{}

	err = json.Unmarshal(data, &varBnsVpcV1ApiUpdateVpcModelVpcModel)

	if err != nil {
		return err
	}

	*o = BnsVpcV1ApiUpdateVpcModelVpcModel(varBnsVpcV1ApiUpdateVpcModelVpcModel)
...
type NullableBnsVpcV1ApiUpdateVpcModelVpcModel struct {
	value *BnsVpcV1ApiUpdateVpcModelVpcModel
	isSet bool
}

func (v NullableBnsVpcV1ApiUpdateVpcModelVpcModel) Get() *BnsVpcV1ApiUpdateVpcModelVpcModel {
	return v.value
}

func (v *NullableBnsVpcV1ApiUpdateVpcModelVpcModel) Set(val *BnsVpcV1ApiUpdateVpcModelVpcModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBnsVpcV1ApiUpdateVpcModelVpcModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBnsVpcV1ApiUpdateVpcModelVpcModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBnsVpcV1ApiUpdateVpcModelVpcModel(val *BnsVpcV1ApiUpdateVpcModelVpcModel) *NullableBnsVpcV1ApiUpdateVpcModelVpcModel {
	return &NullableBnsVpcV1ApiUpdateVpcModelVpcModel{value: val, isSet: true}
}

func (v NullableBnsVpcV1ApiUpdateVpcModelVpcModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBnsVpcV1ApiUpdateVpcModelVpcModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
