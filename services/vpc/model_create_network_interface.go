...
// checks if the CreateNetworkInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkInterface{}

// CreateNetworkInterface struct for CreateNetworkInterface
type CreateNetworkInterface struct {
	// 생성할 네트워크 인터페이스의 이름
	Name        string         `json:"name"`
	Description NullableString `json:"description,omitempty"`
	PrivateIp   NullableString `json:"private_ip,omitempty"`
	// 네트워크 인터페이스를 연결할 서브넷의 ID <br/>- [List subnets](/openapi/networking/vpc/list-subnets)에서 확인
	SubnetId string `json:"subnet_id"`
	// 연결할 보안 그룹의 ID 목록<br/>- 최소 1개 이상 지정 권장<br/>- ※ 생략 시 기본 보안 그룹이 자동 적용되지 않음<br/>- [List security groups](/openapi/networking/vpc/list-security-groups)에서 확인
	SecurityGroups       []string `json:"security_groups"`
	AdditionalProperties map[string]interface{}
}

type _CreateNetworkInterface CreateNetworkInterface
...
func (o *CreateNetworkInterface) SetDescriptionNil() {
...
func (o *CreateNetworkInterface) SetPrivateIpNil() {
	o.PrivateIp.Set(nil)
}
...
func (o CreateNetworkInterface) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkInterface) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNetworkInterface) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkInterface := _CreateNetworkInterface{}

	err = json.Unmarshal(data, &varCreateNetworkInterface)

	if err != nil {
		return err
	}

	*o = CreateNetworkInterface(varCreateNetworkInterface)
...
type NullableCreateNetworkInterface struct {
	value *CreateNetworkInterface
	isSet bool
}

func (v NullableCreateNetworkInterface) Get() *CreateNetworkInterface {
	return v.value
}

func (v *NullableCreateNetworkInterface) Set(val *CreateNetworkInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkInterface(val *CreateNetworkInterface) *NullableCreateNetworkInterface {
	return &NullableCreateNetworkInterface{value: val, isSet: true}
}

func (v NullableCreateNetworkInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
