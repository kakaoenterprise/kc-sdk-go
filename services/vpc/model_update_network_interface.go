...
// checks if the UpdateNetworkInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkInterface{}

// UpdateNetworkInterface struct for UpdateNetworkInterface
...
type _UpdateNetworkInterface UpdateNetworkInterface
...
func (o *UpdateNetworkInterface) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *UpdateNetworkInterface) SetDescriptionNil() {
...
func (o UpdateNetworkInterface) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkInterface) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateNetworkInterface) UnmarshalJSON(data []byte) (err error) {
	varUpdateNetworkInterface := _UpdateNetworkInterface{}

	err = json.Unmarshal(data, &varUpdateNetworkInterface)

	if err != nil {
		return err
	}

	*o = UpdateNetworkInterface(varUpdateNetworkInterface)
...
type NullableUpdateNetworkInterface struct {
	value *UpdateNetworkInterface
	isSet bool
}

func (v NullableUpdateNetworkInterface) Get() *UpdateNetworkInterface {
	return v.value
}

func (v *NullableUpdateNetworkInterface) Set(val *UpdateNetworkInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkInterface(val *UpdateNetworkInterface) *NullableUpdateNetworkInterface {
	return &NullableUpdateNetworkInterface{value: val, isSet: true}
}

func (v NullableUpdateNetworkInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
