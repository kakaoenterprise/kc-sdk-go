...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | Association의 고유 ID | [optional] 
**ResourceAttachmentId** | Pointer to **NullableString** | 연결된 Transit Gateway Attachment ID | [optional] 
...
**TgwRouteTableId** | Pointer to **NullableString** | Association이 속한 라우팅 테이블 ID | [optional] 
**ProvisioningStatus** | Pointer to [**NullableTGWAssociationProvisioningStatus**](TGWAssociationProvisioningStatus.md) | Association의 프로비저닝 상태 | [optional] 
**Resource** | Pointer to [**NullableResource**](Resource.md) | 연결된 리소스의 기본 정보 객체 | [optional] 
