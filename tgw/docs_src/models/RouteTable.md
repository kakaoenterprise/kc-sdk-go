...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 라우팅 테이블 ID | [optional] 
**Name** | Pointer to **NullableString** | 라우팅 테이블 이름 | [optional] 
**Region** | Pointer to **NullableString** | 라우팅 테이블 리전 (예: &#x60;kr-central-2&#x60;) | [optional] 
...
**ProvisioningStatus** | Pointer to [**NullableTGWRouteTableProvisioningStatus**](TGWRouteTableProvisioningStatus.md) | Transit Gateway 프로비저닝 상태 | [optional] 
