...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | Transit Gateway ID | [optional] 
**Name** | Pointer to **NullableString** | Transit Gateway 이름 | [optional] 
**Region** | Pointer to **NullableString** | Transit Gateway가 위치한 리전 | [optional] 
**IsShared** | Pointer to **NullableBool** | 공유된 Transit Gateway 여부 | [optional] 
**Attachments** | Pointer to [**[]Attachment**](Attachment.md) | Transit Gateway에 연결된 Attachment 목록 | [optional] 
**Options** | Pointer to [**NullableOption**](Option.md) | Transit Gateway 옵션 설정 | [optional] 
**ProvisioningStatus** | Pointer to [**NullableTGWProvisioningStatus**](TGWProvisioningStatus.md) | Transit Gateway 프로비저닝 상태 | [optional] 
**ProjectId** | Pointer to **NullableString** | 프로젝트 ID | [optional] 
**ProjectName** | Pointer to **NullableString** | 프로젝트 이름 | [optional] 
**OwnerProjectId** | Pointer to **NullableString** | 소유 프로젝트 ID | [optional] 
**OwnerProjectName** | Pointer to **NullableString** | 소유 프로젝트 이름 | [optional] 
**RouteTables** | Pointer to [**[]RouteTable**](RouteTable.md) | 연결된 라우팅 테이블 목록 | [optional] 
