...
**Description** | Pointer to **NullableString** | 리소스 설명 | [optional] 
**AvailabilityZone** | Pointer to [**NullableAvailabilityZone**](AvailabilityZone.md) | 리소스의 가용 영역 | [optional] 
**CidrBlock** | Pointer to **NullableString** | 리소스의 CIDR 블록 | [optional] 
**OperatingStatus** | Pointer to **NullableString** | 리소스의 운영 상태 | [optional] 
**ProvisioningStatus** | Pointer to [**NullableProvisioningStatus**](ProvisioningStatus.md) | 리소스의 프로비저닝 상태 | [optional] 
**VpcId** | Pointer to **NullableString** | 리소스가 속한 VPC ID | [optional] 
