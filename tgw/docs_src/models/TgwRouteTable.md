...
**Region** | Pointer to **NullableString** | 라우팅 테이블이 위치한 리전 | [optional] 
**TgwId** | Pointer to **NullableString** | Transit Gateway ID | [optional] 
**TgwName** | Pointer to **NullableString** | Transit Gateway 이름 | [optional] 
**IsDefaultAssociationRouteTable** | Pointer to **NullableBool** | 기본 Association 라우팅 테이블 여부 | [optional] 
**IsDefaultPropagationRouteTable** | Pointer to **NullableBool** | 기본 Propagation 라우팅 테이블 여부 | [optional] 
**ProvisioningStatus** | Pointer to [**NullableTGWRouteTableProvisioningStatus**](TGWRouteTableProvisioningStatus.md) | 라우팅 테이블의 프로비저닝 상태 | [optional] 
**Routes** | Pointer to [**[]Route**](Route.md) | 라우팅 테이블에 등록된 Route 목록 | [optional] 
**Associations** | Pointer to [**[]Association**](Association.md) | 라우팅 테이블에 연결된 Association 목록 | [optional] 
