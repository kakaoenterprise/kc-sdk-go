...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | Attachment ID | [optional] 
**InstanceId** | Pointer to **NullableString** | 인스턴스의 고유 ID | [optional] 
**HostName** | Pointer to **NullableString** | 볼륨이 연결된 호스트 이름 | [optional] 
**Device** | Pointer to **NullableString** | 인스턴스에서 인식되는 디바이스 경로 | [optional] 
**AttachedAt** | Pointer to **NullableTime** | 볼륨이 인스턴스에 연결된 시각 | [optional] 
...
`func (o *Attachment) SetInstanceIdNil(b bool)`
...
`func (o *Attachment) SetHostNameNil(b bool)`
...
`func (o *Attachment) SetDeviceNil(b bool)`
...
`func (o *Attachment) SetAttachedAtNil(b bool)`
