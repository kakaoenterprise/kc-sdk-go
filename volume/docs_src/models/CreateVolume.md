...
**Size** | **int32** | 볼륨 크기 (GB 단위) - Linux 계열: 1 ~ 16,384 GB - Windows 계열: 1 ~ 2,048 GB | 
**AvailabilityZone** | [**AvailabilityZone**](AvailabilityZone.md) | 볼륨을 생성할 가용 영역 | 
**VolumeTypeId** | Pointer to **NullableString** | 볼륨 유형 ID - [List volume types](/openapi/bcs/list-volume-types)에서 확인 | [optional] 
**SourceVolumeId** | Pointer to **NullableString** | 원본 볼륨 ID - [List volumes](/openapi/bcs/list-volumes)에서 확인 | [optional] 
...
**ImageId** | Pointer to **NullableString** | 이미지의 고유 ID - [List images](/openapi/bcs/list-images)에서 확인 | [optional] 
