...
**Size** | Pointer to **NullableInt64** | 이미지의 실제 디스크 크기(Byte 단위) | [optional] 
...
**ContainerFormat** | Pointer to **NullableString** | 컨테이너 포맷 형식 | [optional] 
**Owner** | Pointer to **NullableString** | 이미지 소유자(이미지를 소유한 프로젝트 ID) | [optional] 
**MinDisk** | Pointer to **NullableInt32** | 이미지 사용에 필요한 최소 디스크 용량(GB) | [optional] 
**MinRam** | Pointer to **NullableInt32** | 이미지 사용에 필요한 최소 메모리 용량(MB) | [optional] 
