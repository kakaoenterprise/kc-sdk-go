...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 스냅샷 ID | [optional] 
**Name** | Pointer to **NullableString** | 스냅샷 이름 | [optional] 
**Description** | Pointer to **NullableString** | 스냅샷에 대한 설명 | [optional] 
**Size** | Pointer to **NullableInt64** | 스냅샷 크기 (GB) | [optional] 
**Status** | Pointer to **NullableString** | 스냅샷 상태 | [optional] 
**VolumeId** | Pointer to **NullableString** | 볼륨의 고유 ID | [optional] 
**UserId** | Pointer to **NullableString** | 사용자 ID | [optional] 
**ProjectId** | Pointer to **NullableString** | 프로젝트 ID | [optional] 
**ParentId** | Pointer to **NullableString** | 상위 스냅샷 ID | [optional] 
...
**IsIncremental** | Pointer to **NullableBool** | 증분 스냅샷 여부 | [optional] 
**IsDependentSnapshot** | Pointer to **NullableBool** | 종속 스냅샷 여부 | [optional] 
**RealSize** | Pointer to **NullableInt64** | 실제 사용 크기 (Bytes 단위) | [optional] 
**ScheduleId** | Pointer to **NullableString** | 스냅샷이 속한 스케줄 ID | [optional] 
