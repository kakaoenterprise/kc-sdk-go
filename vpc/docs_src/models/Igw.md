...
**Description** | Pointer to **NullableString** | 인터넷 게이트웨이에 대한 설명 | [optional] 
**Vpc** | Pointer to [**NullableInternetGatewayVpc**](InternetGatewayVpc.md) | 인터넷 게이트웨이에 연결된 VPC 정보 | [optional] 
**Attachment** | Pointer to [**NullableAttachment**](Attachment.md) | 인터넷 게이트웨이 Attachment 정보 | [optional] 
**NatIp** | Pointer to **NullableString** | 인터넷 게이트웨이에 할당된 NAT IP 주소 | [optional] 
**ProjectId** | Pointer to **NullableString** | 인터넷 게이트웨이가 속한 프로젝트 ID | [optional] 
**ProjectName** | Pointer to **NullableString** | 인터넷 게이트웨이가 속한 프로젝트 이름 | [optional] 
**DomainId** | Pointer to **NullableString** | 인터넷 게이트웨이가 속한 도메인 ID | [optional] 
**ProvisioningStatus** | Pointer to **NullableString** | 인터넷 게이트웨이의 프로비저닝 상태 | [optional] 
...
**AttachmentStatus** | **string** | IGW Attachment의 연결 상태 - &#x60;Active&#x60;: &#x60;ATTACHED&#x60; - &#x60;Pending_Create&#x60;: &#x60;ATTACHING&#x60; - &#x60;Pending_Delete&#x60;: &#x60;DETACHING&#x60; - 그 외: &#x60;DETACHED&#x60; | 
