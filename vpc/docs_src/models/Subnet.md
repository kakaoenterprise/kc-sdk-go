...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 서브넷을 공유받은 프로젝트의 ID | [optional] 
**Name** | Pointer to **NullableString** | 서브넷 이름 | [optional] 
**Description** | Pointer to **NullableString** | 서브넷에 대한 설명 | [optional] 
**IsShared** | Pointer to **NullableBool** | 공유 여부 | [optional] 
**AvailabilityZone** | Pointer to [**NullableAvailabilityZone**](AvailabilityZone.md) | 서브넷이 위치한 가용 영역 | [optional] 
**CidrBlock** | Pointer to **NullableString** | 서브넷의 IPv4 CIDR 블록 | [optional] 
**ProjectId** | Pointer to **NullableString** | 서브넷이 속한 프로젝트 ID | [optional] 
...
**ProjectName** | Pointer to **NullableString** | 서브넷이 속한 프로젝트 이름 | [optional] 
**OwnerProjectId** | Pointer to **NullableString** | 서브넷을 생성한 소유 프로젝트 ID | [optional] 
**RouteTableId** | Pointer to **NullableString** | 연결된 라우팅 테이블 ID | [optional] 
**RouteTableName** | Pointer to **NullableString** | 연결된 라우팅 테이블 이름 | [optional] 
