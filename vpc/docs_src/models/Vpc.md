...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | VPC의 고유 ID | [optional] 
**Name** | Pointer to **NullableString** | VPC 이름 | [optional] 
**Description** | Pointer to **NullableString** | VPC에 대한 설명 | [optional] 
**Region** | Pointer to [**NullableRegion**](Region.md) | 리전 정보 | [optional] 
**Igw** | Pointer to [**NullableVpcIgw**](VpcIgw.md) | 인터넷 게이트웨이 정보 | [optional] 
**DefaultRouteTable** | Pointer to [**NullableDefaultRouteTable**](DefaultRouteTable.md) | 기본 라우팅 테이블 정보 | [optional] 
**ProjectId** | Pointer to **NullableString** | VPC가 속한 프로젝트 ID | [optional] 
**ProjectName** | Pointer to **NullableString** | VPC가 소속된 프로젝트 이름 | [optional] 
**CidrBlock** | Pointer to **NullableString** | VPC에 할당된 IPv4 주소 범위 (CIDR 형식) | [optional] 
**IsDefault** | Pointer to **NullableBool** | 기본 VPC 여부 | [optional] 
**ProvisioningStatus** | Pointer to [**NullableProvisioningStatus**](ProvisioningStatus.md) | 프로비저닝 상태 | [optional] 
**IsEnableDnsSupport** | Pointer to **NullableBool** | DNS 지원 기능 활성화 여부 | [optional] 
