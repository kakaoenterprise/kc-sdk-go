...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 연결 ID | [optional] 
**ProvisioningStatus** | Pointer to [**NullableProvisioningStatus**](ProvisioningStatus.md) | 프로비저닝 상태 | [optional] 
**VpcId** | Pointer to **NullableString** | 연결된 VPC의 ID | [optional] 
**VpcName** | Pointer to **NullableString** | 연결된 VPC의 이름 | [optional] 
**SubnetId** | Pointer to **NullableString** | 연결된 서브넷의 ID | [optional] 
**SubnetName** | Pointer to **NullableString** | 연결된 서브넷의 이름 | [optional] 
