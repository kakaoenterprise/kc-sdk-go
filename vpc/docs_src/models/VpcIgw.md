...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableString** | 인터넷 게이트웨이의 ID | [optional] 
**Name** | Pointer to **NullableString** | 인터넷 게이트웨이 이름 | [optional] 
**Description** | Pointer to **NullableString** | 인터넷 게이트웨이에 대한 설명 | [optional] 
**Region** | Pointer to [**NullableRegion**](Region.md) | 리전 정보 | [optional] 
**NatIp** | Pointer to **NullableString** | 인터넷 게이트웨이의 NAT IP | [optional] 
**ProjectId** | Pointer to **NullableString** | 인터넷 게이트웨이가 속한 프로젝트의 ID | [optional] 
**OperatingStatus** | Pointer to [**NullableVPCOperatingStatus**](VPCOperatingStatus.md) | 운영 상태 | [optional] 
